import{h as g}from"./index-BDiA27Xx.js";import{F as C}from"./index.es-Bgj_r6ds.js";import{d as F}from"./mg-menu.conf-D_q0UiHu.js";const O={component:"mg-menu-item",title:"Molecules/Menus/mg-menu-item",parameters:{actions:{handles:["item-loaded","item-updated"]}}},a=n=>g("mg-menu",{label:"demo"},g("mg-menu-item",{...C(n,{status:"visible"},["","image","information","label","metadata"]),innerHTML:`${n[""]}${n.image}${n.information}${n.label}${n.metadata}`})),e={render:a,args:{identifier:"identifier",href:void 0,target:void 0,status:void 0,expanded:!1,"":"",image:"",information:"",label:'<span slot="label">My label</span>',metadata:""}},t={render:a,args:{...e.args,href:"./"}},s={render:a,args:{...t.args,target:"_blank"}},r={render:a,args:{...e.args,label:'<span slot="label">My label</span>',image:'<mg-icon icon="user" slot="image"></mg-icon>'}},m={render:a,args:{...e.args,label:'<span slot="label">My label</span>',information:'<mg-badge value="2" label="hello" slot="information"></mg-badge>'}},o={render:a,args:{...e.args,label:'<span slot="label">My label</span>',information:'<mg-badge value="2" label="hello" slot="information"></mg-badge>',image:'<mg-icon icon="user" slot="image"></mg-icon>'}},l={render:a,args:{...e.args,"data-overflow-more":!0,"data-size":"large",label:'<span slot="label">My label</span>',metadata:'<span slot="metadata">My metadata</span>'}},i={render:a,args:{...e.args,expanded:!0,label:'<span slot="label">My label</span>',"":`<mg-menu direction="${F.VERTICAL}" label="submenu">
...
}`,...(y=(v=r.parameters)==null?void 0:v.docs)==null?void 0:y.source}}};var T,x,W;m.parameters={...m.parameters,docs:{...(T=m.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: Template,
  args: {
    ...MgMenuItem.args,
    // Slots
...
}`,...(W=(x=m.parameters)==null?void 0:x.docs)==null?void 0:W.source}}};var A,L,k;o.parameters={...o.parameters,docs:{...(A=o.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: Template,
  args: {
    ...MgMenuItem.args,
    // Slots
...
}`,...(z=(w=i.parameters)==null?void 0:w.docs)==null?void 0:z.source}}};const P=["MgMenuItem","MgMenuItemAsLink","MgMenuItemAsExternalLink","MgMenuItemWhitIcon","MgMenuItemWhitBadge","MgMenuItemWhitBadgeAndIcon","MgMenuItemWhitMetadata","MgMenuItemWithSubmenu"];export{e as MgMenuItem,s as MgMenuItemAsExternalLink,t as MgMenuItemAsLink,m as MgMenuItemWhitBadge,o as MgMenuItemWhitBadgeAndIcon,r as MgMenuItemWhitIcon,l as MgMenuItemWhitMetadata,i as MgMenuItemWithSubmenu,P as __namedExportsOrder,O as default};
