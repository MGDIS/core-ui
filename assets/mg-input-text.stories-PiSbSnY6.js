import{h as l}from"./index-BdigElPL.js";import{f as p}from"./iframe-D0BQJm5n.js";import"./preload-helper-PPVm8Dsz.js";const g={component:"mg-input-text",title:"Molecules/Inputs/mg-input-text",parameters:{actions:{handles:["value-change","input-valid"]}}},a=o=>l("mg-input-text",{...p(o,{type:"text",maxlength:400,mgWidth:"full",tooltipPosition:"input"},["append-input"]),innerHTML:o["append-input"]}),e={render:a,args:{value:"",identifier:"identifier",name:"input-name",label:"Label",labelOnTop:!1,labelHide:!1,type:void 0,icon:void 0,placeholder:"placeholder",datalistoptions:void 0,maxlength:void 0,required:!1,readonly:!1,disabled:!1,mgWidth:void 0,pattern:void 0,patternErrorMessage:void 0,tooltip:"This is a tooltip",tooltipPosition:void 0,characterLeftHide:!1,helpText:"Help text with html <b>bold</b>, <em>italic</em>.","append-input":""}},t={render:a,args:{...e.args,type:"url",tooltip:void 0,label:"Site web",helpText:void 0}},r={render:a,args:{...t.args,type:"email",label:"Adresse email",pattern:/^[a-zA-Z0-9!#$%&'*+\/=?^_`\{\|\}~\-]+(?:\.[a-zA-Z0-9!#$%&'*+\/=?^_`\{\|\}~\-]+)*@(?:[a-zA-Z0-9](?:[a-zA-Z0-9\-]*[a-zA-Z0-9])?\.)+[a-zA-Z0-9](?:[a-zA-Z0-9\-]*[a-zA-Z0-9])?$/.source}},s={render:a,args:{...e.args,type:"search",icon:"magnifying-glass","append-input":`<mg-button slot="append-input" label="search">
...
}`,...i.parameters?.docs?.source}}};const u=["MgInputText","Type","Pattern","Search","Datalist","DatalistOption"];export{n as Datalist,i as DatalistOption,e as MgInputText,r as Pattern,s as Search,t as Type,u as __namedExportsOrder,g as default};
