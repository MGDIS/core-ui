import{h as s}from"./index-BDiA27Xx.js";import{F as u}from"./index.es-Bgj_r6ds.js";const f={component:"mg-input-numeric",title:"Molecules/Inputs/mg-input-numeric",parameters:{actions:{handles:["value-change","input-valid"]}}},d=i=>s("mg-input-numeric",{...u(i,{type:"decimal",currency:"EUR",decimalLength:2,format:"number",integerLength:13,unitDisplay:"short",tooltipPosition:"input"},["append-input"]),innerHTML:i["append-input"]}),e={render:d,args:{value:"",identifier:"identifier",name:"input-name",label:"Label",labelOnTop:!1,labelHide:!1,placeholder:"placeholder",required:!1,readonly:!1,max:void 0,min:void 0,disabled:!1,mgWidth:void 0,tooltip:"This is a tooltip",tooltipPosition:void 0,helpText:"Help text with html <b>bold</b>, <em>italic</em>.",type:void 0,format:void 0,currency:"",unit:"",unitDisplay:void 0,integerLength:void 0,decimalLength:void 0,"append-input":""}},n={render:d,args:{...e.args,"append-input":'<span slot="append-input">km</span>'}};var t,a,p;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`{
  render: Template,
  args: {
    // Props
    'value': '',
