import{h as z}from"./index-CJEt4w-d.js";import{G as C}from"./index.es-WTk4rpsq.js";import{D as G}from"./mg-menu.conf-DGR1PezI.js";const H={component:"mg-menu-item",title:"Molecules/Menus/mg-menu-item",parameters:{actions:{handles:["item-loaded"]}}},a=g=>z("mg-menu-item",{...C(g),innerHTML:g.slot}),e={render:a,args:{slot:'<span slot="label">My label</span>'}},n={render:a,args:{href:"./",...e.args}},s={render:a,args:{href:"./",target:"_blank",...e.args}},r={render:a,args:{...e.args,slot:'<span slot="label">My label</span><mg-icon icon="user" slot="image"></mg-icon>'}},t={render:a,args:{...e.args,slot:'<span slot="label">My label</span><mg-badge value="2" label="hello" slot="information"></mg-badge>'}},m={render:a,args:{...e.args,slot:'<span slot="label">My label</span><mg-badge value="2" label="hello" slot="information"></mg-badge><mg-icon icon="user" slot="image"></mg-icon>'}},o={render:a,args:{...e.args,"data-overflow-more":!0,"data-size":"medium",slot:'<span slot="label">My label</span>, <span slot="metadata">My metadata</span>'}},l={render:a,args:{...e.args,slot:`<span slot="label">My label</span>
...
}`,...(h=(I=s.parameters)==null?void 0:I.docs)==null?void 0:h.source}}};var f,S,y;r.parameters={...r.parameters,docs:{...(f=r.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: Template,
  args: {
    ...MgMenuItem.args,
    slot: \`<span slot="label">My label</span><mg-icon icon="user" slot="image"></mg-icon>\`
  }
}`,...(y=(S=r.parameters)==null?void 0:S.docs)==null?void 0:y.source}}};var T,v,W;t.parameters={...t.parameters,docs:{...(T=t.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: Template,
  args: {
    ...MgMenuItem.args,
    slot: \`<span slot="label">My label</span><mg-badge value="2" label="hello" slot="information"></mg-badge>\`
  }
}`,...(W=(v=t.parameters)==null?void 0:v.docs)==null?void 0:W.source}}};var A,L,k;m.parameters={...m.parameters,docs:{...(A=m.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: Template,
  args: {
    ...MgMenuItem.args,
...
}`,...(w=(D=l.parameters)==null?void 0:D.docs)==null?void 0:w.source}}};const O=["MgMenuItem","MgMenuItemAsLink","MgMenuItemAsExternalLink","MgMenuItemWhitIcon","MgMenuItemWhitBadge","MgMenuItemWhitBadgeAndIcon","MgMenuItemWhitMetadata","MgMenuItemWithSubmenu"];export{e as MgMenuItem,s as MgMenuItemAsExternalLink,n as MgMenuItemAsLink,t as MgMenuItemWhitBadge,m as MgMenuItemWhitBadgeAndIcon,r as MgMenuItemWhitIcon,o as MgMenuItemWhitMetadata,l as MgMenuItemWithSubmenu,O as __namedExportsOrder,H as default};
