import{d as R}from"./index-HFhtBKEF.js";import{I as ze,v as He}from"./preview-errors-7FWlPnjy.js";import{g as _e,s as Oe}from"./utils-mC9zhaFX.js";import{_}from"./iframe-bFFI7vhi.js";const{addons:Re}=__STORYBOOK_MODULE_PREVIEW_API__,{global:Y}=__STORYBOOK_MODULE_GLOBAL__;var Ve="actions",Be="storybook/actions",We=`${Be}/action-event`,V={depth:10,clearOnStoryChange:!0,limit:50},ce=(e,t)=>{let n=Object.getPrototypeOf(e);return!n||t(n)?n:ce(n,t)},je=e=>!!(typeof e=="object"&&e&&ce(e,t=>/^Synthetic(?:Base)?Event$/.test(t.constructor.name))&&typeof e.persist=="function"),Ue=e=>{if(je(e)){let t=Object.create(e.constructor.prototype,Object.getOwnPropertyDescriptors(e));t.persist();let n=Object.getOwnPropertyDescriptor(t,"view"),o=n==null?void 0:n.value;return typeof o=="object"&&(o==null?void 0:o.constructor.name)==="Window"&&Object.defineProperty(t,"view",{...n,value:Object.create(o.constructor.prototype)}),t}return e},Fe=()=>typeof crypto=="object"&&typeof crypto.getRandomValues=="function"?He():Date.now().toString(36)+Math.random().toString(36).substring(2);function Ne(e,t={}){let n={...V,...t},o=function(...a){var d,m;if(t.implicit){let g=(d="__STORYBOOK_PREVIEW__"in Y?Y.__STORYBOOK_PREVIEW__:void 0)==null?void 0:d.storyRenders.find(u=>u.phase==="playing"||u.phase==="rendering");if(g){let u=!((m=window==null?void 0:window.FEATURES)!=null&&m.disallowImplicitActionsInRenderV8),f=new ze({phase:g.phase,name:e,deprecated:u});if(u)console.warn(f);else throw f}}let s=Re.getChannel(),i=Fe(),l=5,r=a.map(Ue),p=a.length>1?r:r[0],c={id:i,count:0,data:{name:e,args:p},options:{...n,maxDepth:l+(n.depth||3),allowFunction:n.allowFunction||!1}};s.emit(We,c)};return o.isAction=!0,o}var Ge=(...e)=>{let t=V,n=e;n.length===1&&Array.isArray(n[0])&&([n]=n),n.length!==1&&typeof n[n.length-1]!="string"&&(t={...V,...n.pop()});let o=n[0];(n.length!==1||typeof o=="string")&&(o={},n.forEach(s=>{o[s]=s}));let a={};return Object.keys(o).forEach(s=>{a[s]=Ne(o[s],t)}),a};const{global:Ke}=__STORYBOOK_MODULE_GLOBAL__,{makeDecorator:Ye,useEffect:Xe}=__STORYBOOK_MODULE_PREVIEW_API__;var{document:X,Element:J}=Ke,Je=/^(\S+)\s*(.*)$/,Ze=J!=null&&!J.prototype.matches,Qe=Ze?"msMatchesSelector":"matches",de=(e,t)=>{if(e[Qe](t))return!0;let n=e.parentElement;return n?de(n,t):!1},et=(e,...t)=>{let n=e(...t);return Object.entries(n).map(([o,a])=>{let[s,i,l]=o.match(Je)||[];return{eventName:i,handler:r=>{(!l||de(r.target,l))&&a(r)}}})},tt=(e,...t)=>{let n=X&&X.getElementById("storybook-root");Xe(()=>{if(n!=null){let o=et(e,...t);return o.forEach(({eventName:a,handler:s})=>n.addEventListener(a,s)),()=>o.forEach(({eventName:a,handler:s})=>n.removeEventListener(a,s))}},[n,e,t])},nt=Ye({name:"withActions",parameterName:Ve,skipIfNoParametersOrOptions:!0,wrapper:(e,t,{parameters:n})=>(n!=null&&n.handles&&tt(Ge,...n.handles),e(t))});const ot="2023-12-21T09:27:54",at={name:"@stencil/core",version:"4.9.0",typescriptVersion:"5.2.2"},st=[{filePath:"src/components/molecules/mg-action-more/mg-action-more.tsx",encapsulation:"shadow",tag:"mg-action-more",readme:`## Anatomy
...
use to match checkbox attributes`,path:"src/components/molecules/inputs/mg-input-checkbox/mg-input-checkbox.conf.ts"},"src/components/molecules/inputs/mg-input-checkbox/mg-input-checkbox.conf.ts::SectionKind":{declaration:`export enum SectionKind {
  ...
  status: Status;
}`,docstring:"",path:"src/components/molecules/mg-tabs/mg-tabs.conf.ts"}},it={timestamp:ot,compiler:at,components:st,typeLibrary:lt},rt="mg-components",pe={allRenderFn:!1,appendChildSlotFix:!1,asyncLoading:!0,asyncQueue:!1,attachStyles:!0,cloneNodeFix:!1,cmpDidLoad:!0,cmpDidRender:!0,cmpDidUnload:!1,cmpDidUpdate:!0,cmpShouldUpdate:!1,cmpWillLoad:!0,cmpWillRender:!1,cmpWillUpdate:!0,connectedCallback:!1,constructableCSS:!0,cssAnnotations:!0,devTools:!1,disconnectedCallback:!0,element:!1,event:!0,experimentalSlotFixes:!1,formAssociated:!1,hasRenderFn:!0,hostListener:!0,hostListenerTarget:!0,hostListenerTargetBody:!1,hostListenerTargetDocument:!1,hostListenerTargetParent:!1,hostListenerTargetWindow:!0,hotModuleReplacement:!1,hydrateClientSide:!1,hydrateServerSide:!1,hydratedAttribute:!1,hydratedClass:!0,initializeNextTick:!1,invisiblePrehydration:!0,isDebug:!1,isDev:!1,isTesting:!1,lazyLoad:!0,lifecycle:!0,lifecycleDOMEvents:!1,member:!0,method:!0,mode:!1,observeAttribute:!0,profile:!1,prop:!0,propBoolean:!0,propMutable:!0,propNumber:!0,propString:!0,reflect:!0,scoped:!0,scopedSlotTextContentFix:!1,scriptDataOpts:!1,shadowDelegatesFocus:!1,shadowDom:!0,slot:!0,slotChildNodesFix:!1,slotRelocation:!0,state:!0,style:!0,svg:!1,taskQueue:!0,transformTagName:!1,updatable:!0,vdomAttribute:!0,vdomClass:!0,vdomFunctional:!0,vdomKey:!0,vdomListener:!0,vdomPropOrAttr:!0,vdomRef:!0,vdomRender:!0,vdomStyle:!0,vdomText:!0,vdomXlink:!0,watchCallback:!0};let w,me,H,ge=!1,P=!1,j=!1,ue=!1,B=!1;const $=(e,t="")=>()=>{},ct=(e,t)=>()=>{},dt="{visibility:hidden}.hydrated{visibility:inherit}",fe="slot-fb{display:contents}slot-fb[hidden]{display:none}",Z="http://www.w3.org/1999/xlink",Q={},pt=e=>e!=null,U=e=>(e=typeof e,e==="object"||e==="function");function he(e){var t,n,o;return(o=(n=(t=e.head)===null||t===void 0?void 0:t.querySelector('meta[name="csp-nonce"]'))===null||n===void 0?void 0:n.getAttribute("content"))!==null&&o!==void 0?o:void 0}const be=(e,t,...n)=>{let o=null,a=null,s=null,i=!1,l=!1;const r=[],p=d=>{for(let m=0;m<d.length;m++)o=d[m],Array.isArray(o)?p(o):o!=null&&typeof o!="boolean"&&((i=typeof e!="function"&&!U(o))&&(o=String(o)),i&&l?r[r.length-1].$text$+=o:r.push(i?L(null,o):o),l=i)};if(p(n),t){t.key&&(a=t.key),t.name&&(s=t.name);{const d=t.className||t.class;d&&(t.class=typeof d!="object"?d:Object.keys(d).filter(m=>d[m]).join(" "))}}if(typeof e=="function")return e(t===null?{}:t,r,ut);const c=L(e,null);return c.$attrs$=t,r.length>0&&(c.$children$=r),c.$key$=a,c.$name$=s,c},L=(e,t)=>{const n={$flags$:0,$tag$:e,$text$:t,$elm$:null,$children$:null};return n.$attrs$=null,n.$key$=null,n.$name$=null,n},mt={},gt=e=>e&&e.$tag$===mt,ut={forEach:(e,t)=>e.map(ee).forEach(t),map:(e,t)=>e.map(ee).map(t).map(ft)},ee=e=>({vattrs:e.$attrs$,vchildren:e.$children$,vkey:e.$key$,vname:e.$name$,vtag:e.$tag$,vtext:e.$text$}),ft=e=>{if(typeof e.vtag=="function"){const n=Object.assign({},e.vattrs);return e.vkey&&(n.key=e.vkey),e.vname&&(n.name=e.vname),be(e.vtag,n,...e.vchildren||[])}const t=L(e.vtag,e.vtext);return t.$attrs$=e.vattrs,t.$children$=e.vchildren,t.$key$=e.vkey,t.$name$=e.vname,t},ht=(e,t)=>e!=null&&!U(e)?t&4?e==="false"?!1:e===""||!!e:t&2?parseFloat(e):t&1?String(e):e:e,bt=e=>I(e).$hostElement$,tn=(e,t,n)=>{const o=bt(e);return{emit:a=>ye(o,t,{bubbles:!!(n&4),composed:!!(n&2),cancelable:!!(n&1),detail:a})}},ye=(e,t,n)=>{const o=h.ce(t,n);return e.dispatchEvent(o),o},te=new WeakMap,yt=(e,t,n)=>{let o=z.get(e);Ft&&n?(o=o||new CSSStyleSheet,typeof o=="string"?o=t:o.replaceSync(t)):o=t,z.set(e,o)},vt=(e,t,n)=>{var o;const a=ve(t),s=z.get(a);if(e=e.nodeType===11?e:v,s)if(typeof s=="string"){e=e.head||e;let i=te.get(e),l;if(i||te.set(e,i=new Set),!i.has(a)){{l=v.createElement("style"),l.innerHTML=s;const r=(o=h.$nonce$)!==null&&o!==void 0?o:he(v);r!=null&&l.setAttribute("nonce",r),e.insertBefore(l,e.querySelector("link"))}t.$flags$&4&&(l.innerHTML+=fe),i&&i.add(a)}}else e.adoptedStyleSheets.includes(s)||(e.adoptedStyleSheets=[...e.adoptedStyleSheets,s]);return a},Tt=e=>{const t=e.$cmpMeta$,n=e.$hostElement$,o=t.$flags$,a=$("attachStyles",t.$tagName$),s=vt(n.shadowRoot?n.shadowRoot:n.getRootNode(),t);o&10&&(n["s-sc"]=s,n.classList.add(s+"-h"),o&2&&n.classList.add(s+"-s")),a()},ve=(e,t)=>"sc-"+e.$tagName$,ne=(e,t,n,o,a,s)=>{if(n!==o){let i=le(e,t),l=t.toLowerCase();if(t==="class"){const r=e.classList,p=oe(n),c=oe(o);r.remove(...p.filter(d=>d&&!c.includes(d))),r.add(...c.filter(d=>d&&!p.includes(d)))}else if(t==="style"){for(const r in n)(!o||o[r]==null)&&(r.includes("-")?e.style.removeProperty(r):e.style[r]="");for(const r in o)(!n||o[r]!==n[r])&&(r.includes("-")?e.style.setProperty(r,o[r]):e.style[r]=o[r])}else if(t!=="key")if(t==="ref")o&&o(e);else if(!i&&t[0]==="o"&&t[1]==="n"){if(t[2]==="-"?t=t.slice(3):le(M,l)?t=l.slice(2):t=l[2]+t.slice(3),n||o){const r=t.endsWith(Te);t=t.replace($t,""),n&&h.rel(e,t,n,r),o&&h.ael(e,t,o,r)}}else{const r=U(o);if((i||r&&o!==null)&&!a)try{if(e.tagName.includes("-"))e[t]=o;else{const c=o??"";t==="list"?i=!1:(n==null||e[t]!=c)&&(e[t]=c)}}catch{}let p=!1;l!==(l=l.replace(/^xlink\:?/,""))&&(t=l,p=!0),o==null||o===!1?(o!==!1||e.getAttribute(t)==="")&&(p?e.removeAttributeNS(Z,t):e.removeAttribute(t)):(!i||s&4||a)&&!r&&(o=o===!0?"":o,p?e.setAttributeNS(Z,t,o):e.setAttribute(t,o))}}},xt=/\s/,oe=e=>e?e.split(xt):[],Te="Capture",$t=new RegExp(Te+"$"),xe=(e,t,n,o)=>{const a=t.$elm$.nodeType===11&&t.$elm$.host?t.$elm$.host:t.$elm$,s=e&&e.$attrs$||Q,i=t.$attrs$||Q;for(o in s)o in i||ne(a,o,s[o],void 0,n,t.$flags$);for(o in i)ne(a,o,s[o],i[o],n,t.$flags$)},C=(e,t,n,o)=>{var a;const s=t.$children$[n];let i=0,l,r,p;if(ge||(j=!0,s.$tag$==="slot"&&(w&&o.classList.add(w+"-s"),s.$flags$|=s.$children$?2:1)),s.$text$!==null)l=s.$elm$=v.createTextNode(s.$text$);else if(s.$flags$&1)l=s.$elm$=v.createTextNode("");else if(l=s.$elm$=v.createElement(s.$flags$&2?"slot-fb":s.$tag$),xe(null,s,ue),pt(w)&&l["s-si"]!==w&&l.classList.add(l["s-si"]=w),s.$children$)for(i=0;i<s.$children$.length;++i)r=C(e,s,i,l),r&&l.appendChild(r);return l["s-hn"]=H,s.$flags$&3&&(l["s-sr"]=!0,l["s-fs"]=(a=s.$attrs$)===null||a===void 0?void 0:a.slot,l["s-cr"]=me,l["s-sn"]=s.$name$||"",p=e&&e.$children$&&e.$children$[n],p&&p.$tag$===s.$tag$&&e.$elm$&&S(e.$elm$,!1)),l},S=(e,t)=>{var n;h.$flags$|=1;const o=e.childNodes;for(let a=o.length-1;a>=0;a--){const s=o[a];s["s-hn"]!==H&&s["s-ol"]&&(Ae(s).insertBefore(s,F(s)),s["s-ol"].remove(),s["s-ol"]=void 0,s["s-sh"]=void 0,s.nodeType===1&&s.setAttribute("slot",(n=s["s-sn"])!==null&&n!==void 0?n:""),j=!0),t&&S(s,t)}h.$flags$&=-2},$e=(e,t,n,o,a,s)=>{let i=e["s-cr"]&&e["s-cr"].parentNode||e,l;for(i.shadowRoot&&i.tagName===H&&(i=i.shadowRoot);a<=s;++a)o[a]&&(l=C(null,n,a,e),l&&(o[a].$elm$=l,i.insertBefore(l,F(t))))},Ie=(e,t,n)=>{for(let o=t;o<=n;++o){const a=e[o];if(a){const s=a.$elm$;Se(a),s&&(P=!0,s["s-ol"]?s["s-ol"].remove():S(s,!0),s.remove())}}},It=(e,t,n,o,a=!1)=>{let s=0,i=0,l=0,r=0,p=t.length-1,c=t[0],d=t[p],m=o.length-1,g=o[0],u=o[m],f,y;for(;s<=p&&i<=m;)if(c==null)c=t[++s];else if(d==null)d=t[--p];else if(g==null)g=o[++i];else if(u==null)u=o[--m];else if(E(c,g,a))k(c,g,a),c=t[++s],g=o[++i];else if(E(d,u,a))k(d,u,a),d=t[--p],u=o[--m];else if(E(c,u,a))(c.$tag$==="slot"||u.$tag$==="slot")&&S(c.$elm$.parentNode,!1),k(c,u,a),e.insertBefore(c.$elm$,d.$elm$.nextSibling),c=t[++s],u=o[--m];else if(E(d,g,a))(c.$tag$==="slot"||u.$tag$==="slot")&&S(d.$elm$.parentNode,!1),k(d,g,a),e.insertBefore(d.$elm$,c.$elm$),d=t[--p],g=o[++i];else{for(l=-1,r=s;r<=p;++r)if(t[r]&&t[r].$key$!==null&&t[r].$key$===g.$key$){l=r;break}l>=0?(y=t[l],y.$tag$!==g.$tag$?f=C(t&&t[i],n,l,e):(k(y,g,a),t[l]=void 0,f=y.$elm$),g=o[++i]):(f=C(t&&t[i],n,i,e),g=o[++i]),f&&Ae(c.$elm$).insertBefore(f,F(c.$elm$))}s>p?$e(e,o[m+1]==null?null:o[m+1].$elm$,n,o,i,m):i>m&&Ie(t,s,p)},E=(e,t,n=!1)=>e.$tag$===t.$tag$?e.$tag$==="slot"?e.$name$===t.$name$:n?!0:e.$key$===t.$key$:!1,F=e=>e&&e["s-ol"]||e,Ae=e=>(e["s-ol"]?e["s-ol"]:e).parentNode,k=(e,t,n=!1)=>{const o=t.$elm$=e.$elm$,a=e.$children$,s=t.$children$,i=t.$tag$,l=t.$text$;let r;l===null?(i==="slot"||xe(e,t,ue),a!==null&&s!==null?It(o,a,t,s,n):s!==null?(e.$text$!==null&&(o.textContent=""),$e(o,null,t,s,0,s.length-1)):a!==null&&Ie(a,0,a.length-1)):(r=o["s-cr"])?r.parentNode.textContent=l:e.$text$!==l&&(o.data=l)},we=e=>{const t=e.childNodes;for(const n of t)if(n.nodeType===1){if(n["s-sr"]){const o=n["s-sn"];n.hidden=!1;for(const a of t)if(a!==n){if(a["s-hn"]!==n["s-hn"]||o!==""){if(a.nodeType===1&&(o===a.getAttribute("slot")||o===a["s-sn"])){n.hidden=!0;break}}else if(a.nodeType===1||a.nodeType===3&&a.textContent.trim()!==""){n.hidden=!0;break}}}we(n)}},T=[],ke=e=>{let t,n,o;for(const a of e.childNodes){if(a["s-sr"]&&(t=a["s-cr"])&&t.parentNode){n=t.parentNode.childNodes;const s=a["s-sn"];for(o=n.length-1;o>=0;o--)if(t=n[o],!t["s-cn"]&&!t["s-nr"]&&t["s-hn"]!==a["s-hn"]&&!pe.experimentalSlotFixes)if(ae(t,s)){let i=T.find(l=>l.$nodeToRelocate$===t);P=!0,t["s-sn"]=t["s-sn"]||s,i?(i.$nodeToRelocate$["s-sh"]=a["s-hn"],i.$slotRefNode$=a):(t["s-sh"]=a["s-hn"],T.push({$slotRefNode$:a,$nodeToRelocate$:t})),t["s-sr"]&&T.map(l=>{ae(l.$nodeToRelocate$,t["s-sn"])&&(i=T.find(r=>r.$nodeToRelocate$===t),i&&!l.$slotRefNode$&&(l.$slotRefNode$=i.$slotRefNode$))})}else T.some(i=>i.$nodeToRelocate$===t)||T.push({$nodeToRelocate$:t})}a.nodeType===1&&ke(a)}},ae=(e,t)=>e.nodeType===1?e.getAttribute("slot")===null&&t===""||e.getAttribute("slot")===t:e["s-sn"]===t?!0:t==="",Se=e=>{e.$attrs$&&e.$attrs$.ref&&e.$attrs$.ref(null),e.$children$&&e.$children$.map(Se)},At=(e,t,n=!1)=>{var o,a,s,i;const l=e.$hostElement$,r=e.$cmpMeta$,p=e.$vnode$||L(null,null),c=gt(t)?t:be(null,null,t);if(H=l.tagName,r.$attrsToReflect$&&(c.$attrs$=c.$attrs$||{},r.$attrsToReflect$.map(([d,m])=>c.$attrs$[m]=l[d])),n&&c.$attrs$)for(const d of Object.keys(c.$attrs$))l.hasAttribute(d)&&!["key","ref","style","class"].includes(d)&&(c.$attrs$[d]=l[d]);c.$tag$=null,c.$flags$|=4,e.$vnode$=c,c.$elm$=p.$elm$=l.shadowRoot||l,w=l["s-sc"],me=l["s-cr"],ge=(r.$flags$&1)!==0,P=!1,k(p,c,n);{if(h.$flags$|=1,j){ke(c.$elm$);for(const d of T){const m=d.$nodeToRelocate$;if(!m["s-ol"]){const g=v.createTextNode("");g["s-nr"]=m,m.parentNode.insertBefore(m["s-ol"]=g,m)}}for(const d of T){const m=d.$nodeToRelocate$,g=d.$slotRefNode$;if(g){const u=g.parentNode;let f=g.nextSibling;{let y=(o=m["s-ol"])===null||o===void 0?void 0:o.previousSibling;for(;y;){let b=(a=y["s-nr"])!==null&&a!==void 0?a:null;if(b&&b["s-sn"]===m["s-sn"]&&u===b.parentNode&&(b=b.nextSibling,!b||!b["s-nr"])){f=b;break}y=y.previousSibling}}(!f&&u!==m.parentNode||m.nextSibling!==f)&&m!==f&&(!m["s-hn"]&&m["s-ol"]&&(m["s-hn"]=m["s-ol"].parentNode.nodeName),u.insertBefore(m,f),m.nodeType===1&&(m.hidden=(s=m["s-ih"])!==null&&s!==void 0?s:!1))}else m.nodeType===1&&(n&&(m["s-ih"]=(i=m.hidden)!==null&&i!==void 0?i:!1),m.hidden=!0)}}P&&we(c.$elm$),h.$flags$&=-2,T.length=0}},Me=(e,t)=>{t&&!e.$onRenderResolve$&&t["s-p"]&&t["s-p"].push(new Promise(n=>e.$onRenderResolve$=n))},N=(e,t)=>{if(e.$flags$|=16,e.$flags$&4){e.$flags$|=512;return}return Me(e,e.$ancestorComponent$),Gt(()=>wt(e,t))},wt=(e,t)=>{const n=$("scheduleUpdate",e.$cmpMeta$.$tagName$),o=e.$lazyInstance$;let a;return t?(e.$flags$|=256,e.$queuedListeners$&&(e.$queuedListeners$.map(([s,i])=>A(o,s,i)),e.$queuedListeners$=void 0),a=A(o,"componentWillLoad")):a=A(o,"componentWillUpdate"),n(),kt(a,()=>Mt(e,o,t))},kt=(e,t)=>St(e)?e.then(t):t(),St=e=>e instanceof Promise||e&&e.then&&typeof e.then=="function",Mt=async(e,t,n)=>{var o;const a=e.$hostElement$,s=$("update",e.$cmpMeta$.$tagName$),i=a["s-rc"];n&&Tt(e);const l=$("render",e.$cmpMeta$.$tagName$);qt(e,t,a,n),i&&(i.map(r=>r()),a["s-rc"]=void 0),l(),s();{const r=(o=a["s-p"])!==null&&o!==void 0?o:[],p=()=>Dt(e);r.length===0?p():(Promise.all(r).then(p),e.$flags$|=4,r.length=0)}},qt=(e,t,n,o)=>{try{t=t.render&&t.render(),e.$flags$&=-17,e.$flags$|=2,At(e,t,o)}catch(a){x(a,e.$hostElement$)}return null},Dt=e=>{const t=e.$cmpMeta$.$tagName$,n=e.$hostElement$,o=$("postUpdate",t),a=e.$lazyInstance$,s=e.$ancestorComponent$;A(a,"componentDidRender"),e.$flags$&64?(A(a,"componentDidUpdate"),o()):(e.$flags$|=64,De(n),A(a,"componentDidLoad"),o(),e.$onReadyResolve$(n),s||qe()),e.$onInstanceResolve$(n),e.$onRenderResolve$&&(e.$onRenderResolve$(),e.$onRenderResolve$=void 0),e.$flags$&512&&K(()=>N(e,!1)),e.$flags$&=-517},qe=e=>{De(v.documentElement),K(()=>ye(M,"appload",{detail:{namespace:rt}}))},A=(e,t,n)=>{if(e&&e[t])try{return e[t](n)}catch(o){x(o)}},De=e=>e.classList.add("hydrated"),Et=(e,t)=>I(e).$instanceValues$.get(t),Pt=(e,t,n,o)=>{const a=I(e),s=a.$hostElement$,i=a.$instanceValues$.get(t),l=a.$flags$,r=a.$lazyInstance$;n=ht(n,o.$members$[t][0]);const p=Number.isNaN(i)&&Number.isNaN(n),c=n!==i&&!p;if((!(l&8)||i===void 0)&&c&&(a.$instanceValues$.set(t,n),r)){if(o.$watchers$&&l&128){const d=o.$watchers$[t];d&&d.map(m=>{try{r[m](n,i,t)}catch(g){x(g,s)}})}(l&18)===2&&N(a,!1)}},Ee=(e,t,n)=>{var o;const a=e.prototype;if(t.$members$){e.watchers&&(t.$watchers$=e.watchers);const s=Object.entries(t.$members$);if(s.map(([i,[l]])=>{l&31||n&2&&l&32?Object.defineProperty(a,i,{get(){return Et(this,i)},set(r){Pt(this,i,r,t)},configurable:!0,enumerable:!0}):n&1&&l&64&&Object.defineProperty(a,i,{value(...r){var p;const c=I(this);return(p=c==null?void 0:c.$onInstancePromise$)===null||p===void 0?void 0:p.then(()=>{var d;return(d=c.$lazyInstance$)===null||d===void 0?void 0:d[i](...r)})}})}),n&1){const i=new Map;a.attributeChangedCallback=function(l,r,p){h.jmp(()=>{var c;const d=i.get(l);if(this.hasOwnProperty(d))p=this[d],delete this[d];else{if(a.hasOwnProperty(d)&&typeof this[d]=="number"&&this[d]==p)return;if(d==null){const m=I(this),g=m==null?void 0:m.$flags$;if(g&&!(g&8)&&g&128&&p!==r){const u=m.$lazyInstance$,f=(c=t.$watchers$)===null||c===void 0?void 0:c[l];f==null||f.forEach(y=>{u[y]!=null&&u[y].call(u,p,r,l)})}return}}this[d]=p===null&&typeof this[d]=="boolean"?!1:p})},e.observedAttributes=Array.from(new Set([...Object.keys((o=t.$watchers$)!==null&&o!==void 0?o:{}),...s.filter(([l,r])=>r[0]&15).map(([l,r])=>{var p;const c=r[1]||l;return i.set(c,l),r[0]&512&&((p=t.$attrsToReflect$)===null||p===void 0||p.push([l,c])),c})]))}}return e},Lt=async(e,t,n,o)=>{let a;if(!(t.$flags$&32)){t.$flags$|=32;{if(a=jt(n),a.then){const r=ct();a=await a,r()}a.isProxied||(n.$watchers$=a.watchers,Ee(a,n,2),a.isProxied=!0);const l=$("createInstance",n.$tagName$);t.$flags$|=8;try{new a(t)}catch(r){x(r)}t.$flags$&=-9,t.$flags$|=128,l()}if(a.style){let l=a.style;const r=ve(n);if(!z.has(r)){const p=$("registerStyles",n.$tagName$);yt(r,l,!!(n.$flags$&1)),p()}}}const s=t.$ancestorComponent$,i=()=>N(t,!0);s&&s["s-rc"]?s["s-rc"].push(i):i()},Ct=e=>{},zt=e=>{if(!(h.$flags$&1)){const t=I(e),n=t.$cmpMeta$,o=$("connectedCallback",n.$tagName$);if(t.$flags$&1)Pe(e,t,n.$listeners$),t!=null&&t.$lazyInstance$||t!=null&&t.$onReadyPromise$&&t.$onReadyPromise$.then(()=>Ct());else{t.$flags$|=1,n.$flags$&12&&Ht(e);{let a=e;for(;a=a.parentNode||a.host;)if(a["s-p"]){Me(t,t.$ancestorComponent$=a);break}}n.$members$&&Object.entries(n.$members$).map(([a,[s]])=>{if(s&31&&e.hasOwnProperty(a)){const i=e[a];delete e[a],e[a]=i}}),Lt(e,t,n)}o()}},Ht=e=>{const t=e["s-cr"]=v.createComment("");t["s-cn"]=!0,e.insertBefore(t,e.firstChild)},se=e=>{A(e,"disconnectedCallback")},_t=async e=>{if(!(h.$flags$&1)){const t=I(e);t.$rmListeners$&&(t.$rmListeners$.map(n=>n()),t.$rmListeners$=void 0),t!=null&&t.$lazyInstance$?se(t.$lazyInstance$):t!=null&&t.$onReadyPromise$&&t.$onReadyPromise$.then(()=>se(t.$lazyInstance$))}},Ot=(e,t={})=>{var n;const o=$(),a=[],s=t.exclude||[],i=M.customElements,l=v.head,r=l.querySelector("meta[charset]"),p=v.createElement("style"),c=[];let d,m=!0;Object.assign(h,t),h.$resourcesUrl$=new URL(t.resourcesUrl||"./",v.baseURI).href;let g=!1;if(e.map(u=>{u[1].map(f=>{var y;const b={$flags$:f[0],$tagName$:f[1],$members$:f[2],$listeners$:f[3]};b.$flags$&4&&(g=!0),b.$members$=f[2],b.$listeners$=f[3],b.$attrsToReflect$=[],b.$watchers$=(y=f[4])!==null&&y!==void 0?y:{};const q=b.$tagName$,Ce=class extends HTMLElement{constructor(D){super(D),D=this,Wt(D,b),b.$flags$&1&&D.attachShadow({mode:"open"})}connectedCallback(){d&&(clearTimeout(d),d=null),m?c.push(this):h.jmp(()=>zt(this))}disconnectedCallback(){h.jmp(()=>_t(this))}componentOnReady(){return I(this).$onReadyPromise$}};b.$lazyBundleId$=u[0],!s.includes(q)&&!i.get(q)&&(a.push(q),i.define(q,Ee(Ce,b,1)))})}),g&&(p.innerHTML+=fe),p.innerHTML+=a+dt,p.innerHTML.length){p.setAttribute("data-styles","");const u=(n=h.$nonce$)!==null&&n!==void 0?n:he(v);u!=null&&p.setAttribute("nonce",u),l.insertBefore(p,r?r.nextSibling:l.firstChild)}m=!1,c.length?c.map(u=>u.connectedCallback()):h.jmp(()=>d=setTimeout(qe,30)),o()},Pe=(e,t,n,o)=>{n&&n.map(([a,s,i])=>{const l=Vt(e,a),r=Rt(t,i),p=Bt(a);h.ael(l,s,r,p),(t.$rmListeners$=t.$rmListeners$||[]).push(()=>h.rel(l,s,r,p))})},Rt=(e,t)=>n=>{try{e.$flags$&256?e.$lazyInstance$[t](n):(e.$queuedListeners$=e.$queuedListeners$||[]).push([t,n])}catch(o){x(o)}},Vt=(e,t)=>t&8?M:e,Bt=e=>(e&2)!==0,G=new WeakMap,I=e=>G.get(e),nn=(e,t)=>G.set(t.$lazyInstance$=e,t),Wt=(e,t)=>{const n={$flags$:0,$hostElement$:e,$cmpMeta$:t,$instanceValues$:new Map};return n.$onInstancePromise$=new Promise(o=>n.$onInstanceResolve$=o),n.$onReadyPromise$=new Promise(o=>n.$onReadyResolve$=o),e["s-p"]=[],e["s-rc"]=[],Pe(e,n,t.$listeners$),G.set(e,n)},le=(e,t)=>t in e,x=(e,t)=>(0,console.error)(e,t),O=new Map,jt=(e,t,n)=>{const o=e.$tagName$.replace(/-/g,"_"),a=e.$lazyBundleId$,s=O.get(a);if(s)return s[o];if(!n||!pe.hotModuleReplacement){const i=l=>(O.set(a,l),l[o]);switch(a){case"mg-action-more_34":return _(()=>import("./mg-action-more_34.entry-9RDeA4FW.js"),__vite__mapDeps([0,1,2,3,4,5,6,7]),import.meta.url).then(i,x);case"mg-item-more":return _(()=>import("./mg-item-more.entry-FaxqcQHX.js"),__vite__mapDeps([8,1,2,3,4,5,6,7]),import.meta.url).then(i,x)}}return _(()=>import(`./${a}.entry.js`),__vite__mapDeps([]),import.meta.url).then(i=>(O.set(a,i),i[o]),x)},z=new Map,M=typeof window<"u"?window:{},v=M.document||{head:{}},h={$flags$:0,$resourcesUrl$:"",jmp:e=>e(),raf:e=>requestAnimationFrame(e),ael:(e,t,n,o)=>e.addEventListener(t,n,o),rel:(e,t,n,o)=>e.removeEventListener(t,n,o),ce:(e,t)=>new CustomEvent(e,t)},Ut=e=>Promise.resolve(e),Ft=(()=>{try{return new CSSStyleSheet,typeof new CSSStyleSheet().replaceSync=="function"}catch{}return!1})(),ie=[],Le=[],Nt=(e,t)=>n=>{e.push(n),B||(B=!0,t&&h.$flags$&4?K(W):h.raf(W))},re=e=>{for(let t=0;t<e.length;t++)try{e[t](performance.now())}catch(n){x(n)}e.length=0},W=()=>{re(ie),re(Le),(B=ie.length>0)&&h.raf(W)},K=e=>Ut().then(e),Gt=Nt(Le,!0),Kt=(e,t)=>{if(!(typeof window>"u"))return Ot(JSON.parse('[["mg-action-more_34",[[1,"mg-input-checkbox",{"value":[1040],"type":[1025],"identifier":[1],"name":[1],"label":[1],"labelOnTop":[4,"label-on-top"],"labelHide":[4,"label-hide"],"inputVerticalList":[4,"input-vertical-list"],"required":[4],"readonly":[4],"displaySelectedValues":[4,"display-selected-values"],"disabled":[4],"tooltip":[1],"helpText":[1,"help-text"],"valid":[1028],"invalid":[1028],"classCollection":[32],"errorMessage":[32],"checkboxItems":[32],"displaySearchInput":[32],"searchValue":[32],"searchResults":[32],"displayError":[64],"setError":[64]},null,{"value":["validateValue"],"type":["validateType"],"required":["handleValidityChange"],"readonly":["handleValidityChange"],"disabled":["handleValidityChange","validateDisabled"],"checkboxItems":["validateCheckboxItems"],"searchValue":["validateSearchValue"]}],[1,"mg-action-more",{"icon":[1040],"button":[16],"items":[16],"displayChevron":[4,"display-chevron"],"expanded":[32]},null,{"icon":["validateIcon"],"button":["validateButton"],"items":["validateItems"],"displayChevron":["validateDisplayChevron"]}],[1,"mg-panel",{"identifier":[1],"panelTitle":[1025,"panel-title"],"titlePattern":[1,"title-pattern"],"titlePatternErrorMessage":[1,"title-pattern-error-message"],"titleEditable":[1028,"title-editable"],"titlePosition":[1,"title-position"],"expanded":[1028],"expandToggleDisplay":[1,"expand-toggle-display"],"expandToggleDisabled":[4,"expand-toggle-disabled"],"classCollection":[32],"isEditing":[32],"updatedPanelTitle":[32]},null,{"panelTitle":["validatePanelTitle"],"titlePattern":["validateTitlePattern"],"titlePatternErrorMessage":["validateTitlePattern"],"titlePosition":["validateTitlePosition"],"expanded":["handleExpanded"],"expandToggleDisplay":["validateExpandToggleDisplay"]}],[1,"mg-input-textarea",{"value":[1537],"identifier":[1],"name":[1],"label":[1],"labelOnTop":[4,"label-on-top"],"labelHide":[4,"label-hide"],"placeholder":[1],"maxlength":[2],"required":[4],"readonly":[4],"disabled":[4],"mgWidth":[8,"mg-width"],"pattern":[1],"patternErrorMessage":[1,"pattern-error-message"],"rows":[2],"tooltip":[1],"displayCharacterLeft":[4,"display-character-left"],"helpText":[1,"help-text"],"valid":[1028],"invalid":[1028],"resizable":[1],"classCollection":[32],"errorMessage":[32],"displayError":[64],"setError":[64]},null,{"value":["handleValue"],"required":["handleValidityChange"],"readonly":["handleValidityChange"],"disabled":["handleValidityChange"],"pattern":["validatePattern"],"patternErrorMessage":["validatePattern"],"displayCharacterLeft":["validateDisplayCharacterLeft"]}],[1,"mg-input-date",{"value":[1537],"identifier":[1],"name":[1],"label":[1],"labelOnTop":[4,"label-on-top"],"labelHide":[4,"label-hide"],"required":[4],"readonly":[4],"disabled":[4],"tooltip":[1],"helpText":[1,"help-text"],"valid":[1028],"invalid":[1028],"min":[1],"max":[1],"classCollection":[32],"errorMessage":[32],"displayError":[64],"setError":[64]},null,{"value":["validateValue"],"required":["handleValidityChange"],"readonly":["handleValidityChange"],"disabled":["handleValidityChange"],"min":["validateMinMax"],"max":["validateMinMax"]}],[1,"mg-input-numeric",{"value":[1537],"identifier":[1],"name":[1],"label":[1],"labelOnTop":[4,"label-on-top"],"labelHide":[4,"label-hide"],"placeholder":[1],"required":[4],"readonly":[4],"disabled":[4],"mgWidth":[8,"mg-width"],"tooltip":[1],"helpText":[1,"help-text"],"type":[1],"currency":[1],"max":[2],"min":[2],"integerLength":[2,"integer-length"],"decimalLength":[2,"decimal-length"],"valid":[1028],"invalid":[1028],"classCollection":[32],"errorMessage":[32],"hasFocus":[32],"displayError":[64],"setError":[64]},null,{"value":["validateValue"],"required":["handleValidityChange"],"readonly":["handleValidityChange"],"disabled":["handleValidityChange"],"type":["validateType"],"integerLength":["validateIntegerLength"],"decimalLength":["validateDecimalLength"]}],[1,"mg-input-password",{"value":[1537],"identifier":[1],"name":[1],"label":[1],"labelOnTop":[4,"label-on-top"],"labelHide":[4,"label-hide"],"placeholder":[1],"required":[4],"readonly":[4],"disabled":[4],"mgWidth":[8,"mg-width"],"tooltip":[1],"helpText":[1,"help-text"],"valid":[1028],"invalid":[1028],"classCollection":[32],"errorMessage":[32],"displayError":[64],"setError":[64]},null,{"value":["handleValue"],"required":["handleValidityChange"],"readonly":["handleValidityChange"],"disabled":["handleValidityChange"]}],[1,"mg-input-radio",{"value":[1032],"items":[16],"identifier":[1],"name":[1],"label":[1],"labelOnTop":[4,"label-on-top"],"labelHide":[4,"label-hide"],"inputVerticalList":[4,"input-vertical-list"],"required":[4],"readonly":[4],"disabled":[4],"tooltip":[1],"helpText":[1,"help-text"],"valid":[1028],"invalid":[1028],"classCollection":[32],"errorMessage":[32],"options":[32],"displayError":[64],"setError":[64]},null,{"value":["handleValue"],"items":["validateItems"],"required":["handleValidityChange"],"readonly":["handleValidityChange"],"disabled":["handleValidityChange"]}],[1,"mg-input-toggle",{"value":[1032],"items":[16],"identifier":[1],"name":[1],"label":[1],"labelOnTop":[4,"label-on-top"],"labelHide":[4,"label-hide"],"isOnOff":[4,"is-on-off"],"isIcon":[4,"is-icon"],"readonly":[4],"disabled":[4],"tooltip":[1],"helpText":[1,"help-text"],"classCollection":[32],"options":[32],"errorMessage":[32],"valid":[32],"checked":[32],"setError":[64]},null,{"value":["handleValue"],"items":["validateItems"],"isOnOff":["handleIsOnOff"],"isIcon":["handleIsIcon"],"readonly":["handleReadonly"],"disabled":["handleDisabled"],"checked":["handleChecked"]}],[1,"mg-message",{"identifier":[1],"delay":[2],"variant":[1],"closeButton":[1028,"close-button"],"hide":[1028],"noAriaRole":[4,"no-aria-role"],"classCollection":[32],"hasActions":[32]},null,{"delay":["validateDelay"],"variant":["validateVariant"],"closeButton":["validateCloseButton"],"hide":["validateHide"]}],[1,"mg-modal",{"identifier":[1],"dialogRole":[1,"dialog-role"],"modalTitle":[1,"modal-title"],"closeButton":[4,"close-button"],"hide":[1028],"hasActions":[32],"hasContent":[32],"classCollection":[32]},[[8,"keydown","handleKeyDown"]],{"dialogRole":["validateDialogRole"],"modalTitle":["validateModalTitle"],"hide":["validateHide"]}],[1,"mg-tabs",{"identifier":[1],"label":[1],"size":[1],"items":[16],"activeTab":[1538,"active-tab"],"tabs":[32],"classCollection":[32]},null,{"label":["validateLabel"],"size":["validateSize"],"items":["validateItems"],"activeTab":["validateActiveTab"]}],[1,"mg-details",{"toggleClosed":[1,"toggle-closed"],"toggleOpened":[1,"toggle-opened"],"hideSummary":[4,"hide-summary"],"expanded":[1028]},null,{"toggleClosed":["validateTitles"],"toggleOpened":["validateTitles"],"expanded":["handleExpanded"]}],[1,"mg-divider",{"size":[1]}],[1,"mg-form",{"identifier":[1],"name":[1],"readonly":[4],"requiredMessage":[1,"required-message"],"ariaRole":[1,"aria-role"],"disabled":[4],"valid":[1028],"invalid":[1028],"classCollection":[32],"requiredMessageText":[32],"displayError":[64]},null,{"requiredMessage":["validateRequiredMessage","handleAttributeChange"],"ariaRole":["validateAriaRole"],"readonly":["handleAttributeChange"],"disabled":["handleAttributeChange"]}],[1,"mg-illustrated-message",{"size":[1],"direction":[1]}],[1,"mg-skip-links",{"links":[16]},null,{"links":["validateLinks"]}],[1,"mg-tag",{"variant":[1],"outline":[4],"soft":[4],"classCollection":[32]},null,{"variant":["validateVariant"],"outline":["validateOutline"],"soft":["validateSoft"]}],[2,"mg-input-checkbox-paginated",{"readonly":[4],"disabled":[4],"name":[1],"invalid":[4],"currentPage":[1026,"current-page"],"checkboxes":[16],"sectionKind":[1,"section-kind"],"messages":[16],"titleKind":[32],"expanded":[32]},null,{"checkboxes":["validateCheckboxes"],"sectionKind":["validateSectionKind"]}],[1,"mg-menu-item",{"identifier":[1],"href":[1],"status":[1537],"expanded":[1028],"size":[32],"navigationButtonClassList":[32],"direction":[32],"isInMainMenu":[32],"isItemMore":[32],"hasChildren":[32],"displayNotificationBadge":[32]},null,{"status":["validateStatus"],"expanded":["validateExpanded"],"size":["validateSize"],"direction":["validateDirection"],"hasChildren":["validateHasChildren"]}],[1,"mg-pagination",{"identifier":[1],"label":[1025],"hideNavigationLabels":[4,"hide-navigation-labels"],"hidePageCount":[4,"hide-page-count"],"totalPages":[2,"total-pages"],"currentPage":[1538,"current-page"]},null,{"totalPages":["validateTotalPages"],"currentPage":["validateCurrentPage"]}],[1,"mg-input-text",{"value":[1537],"identifier":[1],"name":[1],"label":[1],"type":[1],"icon":[1],"labelOnTop":[4,"label-on-top"],"labelHide":[4,"label-hide"],"placeholder":[1],"datalistoptions":[16],"maxlength":[2],"required":[4],"readonly":[4],"disabled":[4],"mgWidth":[8,"mg-width"],"pattern":[1],"patternErrorMessage":[1,"pattern-error-message"],"tooltip":[1],"displayCharacterLeft":[4,"display-character-left"],"helpText":[1,"help-text"],"valid":[1028],"invalid":[1028],"classCollection":[32],"errorMessage":[32],"setFocus":[64],"displayError":[64],"setError":[64]},null,{"value":["handleValue"],"icon":["validateIcon"],"datalistoptions":["validateDatalistoptions"],"required":["handleValidityChange"],"readonly":["handleValidityChange"],"disabled":["handleValidityChange"],"pattern":["validatePattern"],"patternErrorMessage":["validatePattern"]}],[1,"mg-menu",{"label":[1],"direction":[513],"itemmore":[16],"size":[1],"isChildMenu":[32]},null,{"label":["validateLabel"],"direction":["validateDirection"],"itemmore":["validateItemMore"],"size":["validateSize"]}],[1,"mg-input-select",{"value":[1032],"items":[16],"identifier":[1],"name":[1],"label":[1],"labelOnTop":[4,"label-on-top"],"labelHide":[4,"label-hide"],"placeholder":[1025],"placeholderHide":[4,"placeholder-hide"],"placeholderDisabled":[4,"placeholder-disabled"],"required":[4],"readonly":[4],"disabled":[4],"mgWidth":[520,"mg-width"],"tooltip":[1],"helpText":[1,"help-text"],"valid":[1028],"invalid":[1028],"classCollection":[32],"errorMessage":[32],"options":[32],"valueExist":[32],"readonlyValue":[32],"displayError":[64],"setError":[64]},null,{"value":["validateValue"],"items":["validateItems"],"required":["handleValidityChange"],"readonly":["handleValidityChange"],"disabled":["handleValidityChange"]}],[1,"mg-popover",{"identifier":[1],"placement":[1],"arrowHide":[4,"arrow-hide"],"closeButton":[4,"close-button"],"display":[1028],"disabled":[4]},null,{"identifier":["validateIdentifier"],"arrowHide":["validateArrowHide"],"closeButton":["validateCloseButton"],"display":["handleDisplay"]}],[1,"mg-badge",{"value":[8],"label":[1],"variant":[1],"outline":[4],"classCollection":[32]},null,{"value":["validateValue"],"label":["validateLabel"],"variant":["validateVariant"],"outline":["validateOutline"]}],[2,"mg-character-left",{"identifier":[1],"characters":[1],"maxlength":[2]},null,{"maxlength":["validateMaxlength"]}],[1,"mg-popover-content",{"closeButton":[4,"close-button"],"classCollection":[32]}],[1,"mg-card",{"variant":[1],"variantStyle":[1025,"variant-style"],"classCollection":[32]},null,{"variant":["validateVariant"],"variantStyle":["validateVariantStyle"]}],[1,"mg-button",{"variant":[1],"identifier":[1],"label":[1],"type":[1],"fullWidth":[4,"full-width"],"form":[1],"disabled":[1028],"isIcon":[4,"is-icon"],"disableOnClick":[4,"disable-on-click"],"loading":[32],"classCollection":[32]},null,{"variant":["validateVariant"],"fullWidth":["validateFullWidth"],"disabled":["disabledHandler"],"loading":["loadingHandler"]}],[1,"mg-tooltip",{"identifier":[1],"message":[1],"placement":[1],"display":[1028],"disabled":[4]},null,{"identifier":["validateIdentifier"],"message":["validateMessage"],"display":["handleDisplay"],"disabled":["validateDisabled"]}],[6,"mg-input-title",{"identifier":[1],"required":[4],"readonly":[4],"isLegend":[4,"is-legend"],"tagName":[32]},null,{"identifier":["validateIdentifier"],"isLegend":["validateIsLegend"]}],[1,"mg-tooltip-content",{"message":[1]}],[1,"mg-icon",{"icon":[1],"size":[1],"variant":[1],"variantStyle":[1025,"variant-style"],"spin":[4],"classCollection":[32]},null,{"icon":["validateIcon"],"size":["validateSize"],"variant":["validateVariant"],"variantStyle":["validateVariantStyle"],"spin":["handleSpin"]}]]],["mg-item-more",[[1,"mg-item-more",{"icon":[16],"slotlabel":[16],"size":[1],"parentMenu":[32]},null,{"icon":["validateIcon"],"slotlabel":["validateSlotLabel"],"size":["validateSize"]}]]]]'),t)};(function(){if(typeof window<"u"&&window.Reflect!==void 0&&window.customElements!==void 0){var e=HTMLElement;window.HTMLElement=function(){return Reflect.construct(e,[],this.constructor)},HTMLElement.prototype=e.prototype,HTMLElement.prototype.constructor=HTMLElement,Object.setPrototypeOf(HTMLElement,e)}})();Kt();R.setStencilDocJson(it);const Yt={controls:{matchers:{color:/(background|color)$/i,date:/Date$/}},docs:{extractArgTypes:R.extractArgTypes,extractComponentDescription:R.extractComponentDescription,transformSource:(e,t)=>_e(t.originalStoryFn(t.args))},options:{storySort:{order:["Intro","Atoms","Molecules","Style"]}}},Xt=[Oe,nt],on=Object.freeze(Object.defineProperty({__proto__:null,decorators:Xt,parameters:Yt},Symbol.toStringTag,{value:"Module"}));export{mt as H,tn as c,bt as g,be as h,on as p,nn as r};
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["./mg-action-more_34.entry-9RDeA4FW.js","./components.utils-0d67c31c-EPmJvLlW.js","./index-HFhtBKEF.js","./_commonjsHelpers-4gQjN7DL.js","./preview-errors-7FWlPnjy.js","./index-PPLHz8o0.js","./utils-mC9zhaFX.js","./iframe-bFFI7vhi.js","./mg-item-more.entry-FaxqcQHX.js"]
  }
