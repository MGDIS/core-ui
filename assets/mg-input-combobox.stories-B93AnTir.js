import{h as f}from"./index-BDiA27Xx.js";import{s as h}from"./index.es-CvGFZpni.js";const v={component:"mg-input-combobox",title:"Molecules/Inputs/mg-input-combobox",parameters:{actions:{handles:["value-change","input-valid","filter-change","load-more"]}},tags:["beta"]},I=n=>new Array(n).fill(()=>"").map((x,a)=>({title:`title ${a+1}`,value:`/${a+1}`})),s=n=>f("mg-input-combobox",{...h(n)}),e={render:s,args:{value:"",items:["Batman","Robin","Joker"],itemsLabel:"DC Comics",identifier:"identifier",name:"input-name",label:"Label",labelOnTop:!1,labelHide:!1,placeholder:"placeholder",required:!1,readonly:!1,disabled:!1,mgWidth:void 0,tooltip:"This is a tooltip",tooltipPosition:void 0,helpText:"Help text with html <b>bold</b>, <em>italic</em>.",fetchurl:void 0,fetchoptions:void 0,fetchmappings:void 0}},t={render:s,args:{...e.args,items:I(100)}},r={filter:"{q}"},$={items:"d.results",total:"d.__count",next:"d.__next",itemTitle:"libpayscourtmaj",itemValue:"codpaysnum"},o={render:s,args:{...e.args,items:void 0,fetchurl:`https://mdmmgdis.mgcloud.fr/dataserver/mdmmgdis/data/mdmpays?$format=json&$top=20&$inlinecount=allpages&$orderby=${encodeURIComponent("libpayscourtmaj asc")}&$filter=${encodeURIComponent("langue eq 'fr' and substringof('")}${r.filter}${encodeURIComponent("',tolower(libpayscourtmaj))")}`,fetchmappings:{request:r,response:$}}};var i,m,l;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`{
  render: Template,
  args: {
    value: '',
