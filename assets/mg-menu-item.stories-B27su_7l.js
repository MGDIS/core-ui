import{h as g}from"./index-BdigElPL.js";import{f as u}from"./iframe-avHky8ts.js";import{d}from"./mg-menu.conf-D_q0UiHu.js";import"./preload-helper-PPVm8Dsz.js";const f={component:"mg-menu-item",title:"Molecules/Menus/mg-menu-item",parameters:{actions:{handles:["item-loaded","item-updated"]}}},a=n=>g("mg-menu",{label:"demo"},g("mg-menu-item",{...u(n,{status:"visible"},["","image","information","label","metadata"]),innerHTML:`${n[""]}${n.image}${n.information}${n.label}${n.metadata}`})),e={render:a,args:{identifier:"identifier",href:void 0,target:void 0,status:void 0,expanded:!1,"":"",image:"",information:"",label:'<span slot="label">My label</span>',metadata:""}},t={render:a,args:{...e.args,href:"./"}},s={render:a,args:{...t.args,target:"_blank"}},r={render:a,args:{...e.args,label:'<span slot="label">My label</span>',image:'<mg-icon icon="user" slot="image"></mg-icon>'}},m={render:a,args:{...e.args,label:'<span slot="label">My label</span>',information:'<mg-badge value="2" label="hello" slot="information"></mg-badge>'}},o={render:a,args:{...e.args,label:'<span slot="label">My label</span>',information:'<mg-badge value="2" label="hello" slot="information"></mg-badge>',image:'<mg-icon icon="user" slot="image"></mg-icon>'}},l={render:a,args:{...e.args,"data-overflow-more":!0,"data-size":"large",label:'<span slot="label">My label</span>',metadata:'<span slot="metadata">My metadata</span>'}},i={render:a,args:{...e.args,expanded:!0,label:'<span slot="label">My label</span>',"":`<mg-menu direction="${d.VERTICAL}" label="submenu">
