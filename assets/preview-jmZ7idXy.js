import{d as R}from"./index-HFhtBKEF.js";import{I as ze,v as He}from"./preview-errors-7FWlPnjy.js";import{L as Oe,m as _e}from"./index.es-PXOAO2Jp.js";import{_ as O}from"./iframe-YOp4NnM4.js";const{addons:Re}=__STORYBOOK_MODULE_PREVIEW_API__,{global:X}=__STORYBOOK_MODULE_GLOBAL__;var Ve="actions",Be="storybook/actions",We=`${Be}/action-event`,V={depth:10,clearOnStoryChange:!0,limit:50},de=(e,t)=>{let n=Object.getPrototypeOf(e);return!n||t(n)?n:de(n,t)},je=e=>!!(typeof e=="object"&&e&&de(e,t=>/^Synthetic(?:Base)?Event$/.test(t.constructor.name))&&typeof e.persist=="function"),Ue=e=>{if(je(e)){let t=Object.create(e.constructor.prototype,Object.getOwnPropertyDescriptors(e));t.persist();let n=Object.getOwnPropertyDescriptor(t,"view"),o=n==null?void 0:n.value;return typeof o=="object"&&(o==null?void 0:o.constructor.name)==="Window"&&Object.defineProperty(t,"view",{...n,value:Object.create(o.constructor.prototype)}),t}return e},Fe=()=>typeof crypto=="object"&&typeof crypto.getRandomValues=="function"?He():Date.now().toString(36)+Math.random().toString(36).substring(2);function Ne(e,t={}){let n={...V,...t},o=function(...a){var d,m;if(t.implicit){let g=(d="__STORYBOOK_PREVIEW__"in X?X.__STORYBOOK_PREVIEW__:void 0)==null?void 0:d.storyRenders.find(u=>u.phase==="playing"||u.phase==="rendering");if(g){let u=!((m=window==null?void 0:window.FEATURES)!=null&&m.disallowImplicitActionsInRenderV8),f=new ze({phase:g.phase,name:e,deprecated:u});if(u)console.warn(f);else throw f}}let i=Re.getChannel(),s=Fe(),r=5,l=a.map(Ue),p=a.length>1?l:l[0],c={id:s,count:0,data:{name:e,args:p},options:{...n,maxDepth:r+(n.depth||3),allowFunction:n.allowFunction||!1}};i.emit(We,c)};return o.isAction=!0,o}var Ge=(...e)=>{let t=V,n=e;n.length===1&&Array.isArray(n[0])&&([n]=n),n.length!==1&&typeof n[n.length-1]!="string"&&(t={...V,...n.pop()});let o=n[0];(n.length!==1||typeof o=="string")&&(o={},n.forEach(i=>{o[i]=i}));let a={};return Object.keys(o).forEach(i=>{a[i]=Ne(o[i],t)}),a};const{global:Ke}=__STORYBOOK_MODULE_GLOBAL__,{makeDecorator:Ye,useEffect:Xe}=__STORYBOOK_MODULE_PREVIEW_API__;var{document:J,Element:Z}=Ke,Je=/^(\S+)\s*(.*)$/,Ze=Z!=null&&!Z.prototype.matches,Qe=Ze?"msMatchesSelector":"matches",pe=(e,t)=>{if(e[Qe](t))return!0;let n=e.parentElement;return n?pe(n,t):!1},et=(e,...t)=>{let n=e(...t);return Object.entries(n).map(([o,a])=>{let[i,s,r]=o.match(Je)||[];return{eventName:s,handler:l=>{(!r||pe(l.target,r))&&a(l)}}})},tt=(e,...t)=>{let n=J&&J.getElementById("storybook-root");Xe(()=>{if(n!=null){let o=et(e,...t);return o.forEach(({eventName:a,handler:i})=>n.addEventListener(a,i)),()=>o.forEach(({eventName:a,handler:i})=>n.removeEventListener(a,i))}},[n,e,t])},nt=Ye({name:"withActions",parameterName:Ve,skipIfNoParametersOrOptions:!0,wrapper:(e,t,{parameters:n})=>(n!=null&&n.handles&&tt(Ge,...n.handles),e(t))});const ot="2024-01-31T10:31:09",at={name:"@stencil/core",version:"4.11.0",typescriptVersion:"5.3.3"},st=[{filePath:"src/components/molecules/mg-action-more/mg-action-more.tsx",encapsulation:"shadow",tag:"mg-action-more",readme:`## Anatomy
