import{h as l}from"./index-BDiA27Xx.js";import{t as u}from"./index.es-CXAHyUQd.js";const b=["decimal","integer"],x={component:"mg-input-numeric",title:"Molecules/Inputs/mg-input-numeric",parameters:{actions:{handles:["value-change","input-valid"]}}},h=e=>l("mg-input-numeric",{...u(e)}),n={render:h,args:{value:"",identifier:"identifier",name:"input-name",type:b[0],label:"Label",labelOnTop:!1,labelHide:!1,placeholder:"placeholder",required:!0,disabled:!1,readonly:!1,max:void 0,min:void 0,mgWidth:void 0,tooltip:"This is a tooltip",tooltipPosition:void 0,helpText:"Help text with html <b>bold</b>, <em>italic</em>."}},f=e=>{const s=e.labelOnTop;delete e.labelOnTop;const m=e.labelHide;delete e.labelHide;const c=e.helpText;return delete e.helpText,l("mg-input-numeric",{...e,"label-on-top":s,"label-hide":m,"help-text":c},l("span",{slot:"append-input"},"km"))},t={render:f,args:{...n.args}};var i,a,o;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`{
  render: Template,
  args: {
    // Global
    value: '',
