import{h as u}from"./index-BDiA27Xx.js";import{Q as T}from"./index.es-xDe083ye.js";const S={component:"mg-tooltip",title:"Atoms/mg-tooltip",parameters:{layout:"centered"}},r=s=>u("mg-tooltip",{...T(s,{placement:"bottom"},[""]),innerHTML:s[""]}),e={render:r,args:{identifier:"identifier",message:"This is a tooltip message",placement:void 0,display:!1,disabled:!1,"":'<mg-icon icon="info-circle"></mg-icon>'}},o={render:r,args:{...e.args,"":"<mg-button>Action</mg-button>"}},t={render:r,args:{...e.args,"":"<span>any text</span>"}};var a,n,i;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`{
  render: Template,
  args: {
    // Props
