function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["./mg-action-more_34.entry-HQZ7GgX_.js","./index-bb17de92-CiUTBjrm.js","./mg-menu.conf-9609bcb2-CVytr2H4.js","./index-FwRSe4z1.js","./_commonjsHelpers-BosuxZz1.js","./preview-errors-Dg5lG0lC.js","./index-DrFu-skq.js","./index.es-BGsq6_6D.js","./iframe-B3dwf_t5.js","./mg-item-more.entry-xpwQzger.js","./mg-loader.entry-DAyFGOPy.js"]
  }
  return indexes.map((i) => __vite__mapDeps.viteFileDeps[i])
}
import{d as R}from"./index-FwRSe4z1.js";import{I as ze,v as He}from"./preview-errors-Dg5lG0lC.js";import{X as Oe,I as _e}from"./index.es-BGsq6_6D.js";import{_ as E}from"./iframe-B3dwf_t5.js";const{addons:Re}=__STORYBOOK_MODULE_PREVIEW_API__,{global:J}=__STORYBOOK_MODULE_GLOBAL__;var Ve="actions",Be="storybook/actions",We=`${Be}/action-event`,V={depth:10,clearOnStoryChange:!0,limit:50},pe=(e,t)=>{let n=Object.getPrototypeOf(e);return!n||t(n)?n:pe(n,t)},je=e=>!!(typeof e=="object"&&e&&pe(e,t=>/^Synthetic(?:Base)?Event$/.test(t.constructor.name))&&typeof e.persist=="function"),Ue=e=>{if(je(e)){let t=Object.create(e.constructor.prototype,Object.getOwnPropertyDescriptors(e));t.persist();let n=Object.getOwnPropertyDescriptor(t,"view"),o=n==null?void 0:n.value;return typeof o=="object"&&(o==null?void 0:o.constructor.name)==="Window"&&Object.defineProperty(t,"view",{...n,value:Object.create(o.constructor.prototype)}),t}return e},Fe=()=>typeof crypto=="object"&&typeof crypto.getRandomValues=="function"?He():Date.now().toString(36)+Math.random().toString(36).substring(2);function Ne(e,t={}){let n={...V,...t},o=function(...a){var d,m;if(t.implicit){let g=(d="__STORYBOOK_PREVIEW__"in J?J.__STORYBOOK_PREVIEW__:void 0)==null?void 0:d.storyRenders.find(u=>u.phase==="playing"||u.phase==="rendering");if(g){let u=!((m=window==null?void 0:window.FEATURES)!=null&&m.disallowImplicitActionsInRenderV8),f=new ze({phase:g.phase,name:e,deprecated:u});if(u)console.warn(f);else throw f}}let l=Re.getChannel(),s=Fe(),r=5,i=a.map(Ue),p=a.length>1?i:i[0],c={id:s,count:0,data:{name:e,args:p},options:{...n,maxDepth:r+(n.depth||3),allowFunction:n.allowFunction||!1}};l.emit(We,c)};return o.isAction=!0,o}var Ge=(...e)=>{let t=V,n=e;n.length===1&&Array.isArray(n[0])&&([n]=n),n.length!==1&&typeof n[n.length-1]!="string"&&(t={...V,...n.pop()});let o=n[0];(n.length!==1||typeof o=="string")&&(o={},n.forEach(l=>{o[l]=l}));let a={};return Object.keys(o).forEach(l=>{a[l]=Ne(o[l],t)}),a};const{global:Ke}=__STORYBOOK_MODULE_GLOBAL__,{makeDecorator:Ye,useEffect:Xe}=__STORYBOOK_MODULE_PREVIEW_API__;var{document:Z,Element:Q}=Ke,Je=/^(\S+)\s*(.*)$/,Ze=Q!=null&&!Q.prototype.matches,Qe=Ze?"msMatchesSelector":"matches",me=(e,t)=>{if(e[Qe](t))return!0;let n=e.parentElement;return n?me(n,t):!1},et=(e,...t)=>{let n=e(...t);return Object.entries(n).map(([o,a])=>{let[l,s,r]=o.match(Je)||[];return{eventName:s,handler:i=>{(!r||me(i.target,r))&&a(i)}}})},tt=(e,...t)=>{let n=Z&&Z.getElementById("storybook-root");Xe(()=>{if(n!=null){let o=et(e,...t);return o.forEach(({eventName:a,handler:l})=>n.addEventListener(a,l)),()=>o.forEach(({eventName:a,handler:l})=>n.removeEventListener(a,l))}},[n,e,t])},nt=Ye({name:"withActions",parameterName:Ve,skipIfNoParametersOrOptions:!0,wrapper:(e,t,{parameters:n})=>(n!=null&&n.handles&&tt(Ge,...n.handles),e(t))});const ot="2024-03-12T13:49:53",at={name:"@stencil/core",version:"4.12.6",typescriptVersion:"5.3.3"},st=[{filePath:"src/components/molecules/mg-action-more/mg-action-more.tsx",encapsulation:"shadow",tag:"mg-action-more",readme:`## Anatomy
