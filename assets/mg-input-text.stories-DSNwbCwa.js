import{i as e}from"./preload-helper-xPQekRTU.js";import{c as t,l as n}from"./iframe-D41dZqYB.js";import{n as r,t as i}from"./stencil-core-C67Xr0gu.js";var a,o,s,c,l,u,d,f,p;e((()=>{i(),n(),a={component:`mg-input-text`,title:`Molecules/Inputs/mg-input-text`,parameters:{actions:{handles:[`value-change`,`input-valid`]}}},o=e=>r(`mg-input-text`,{...t(e,{type:`text`,maxlength:400,mgWidth:`full`,tooltipPosition:`input`},[`append-input`]),innerHTML:e[`append-input`]}),s={render:o,args:{value:``,identifier:`identifier`,name:`input-name`,label:`Label`,labelOnTop:!1,labelHide:!1,type:void 0,icon:void 0,placeholder:`placeholder`,datalistoptions:void 0,maxlength:void 0,required:!1,readonly:!1,disabled:!1,mgWidth:void 0,pattern:void 0,patternErrorMessage:void 0,tooltip:`This is a tooltip`,tooltipPosition:void 0,characterLeftHide:!1,helpText:`Help text with html <b>bold</b>, <em>italic</em>.`,"append-input":``}},c={render:o,args:{...s.args,type:`url`,tooltip:void 0,label:`Site web`,helpText:void 0}},l={render:o,args:{...c.args,type:`email`,label:`Adresse email`,pattern:"^[a-zA-Z0-9!#$%&'*+\\/=?^_`\\{\\|\\}~\\-]+(?:\\.[a-zA-Z0-9!#$%&'*+\\/=?^_`\\{\\|\\}~\\-]+)*@(?:[a-zA-Z0-9](?:[a-zA-Z0-9\\-]*[a-zA-Z0-9])?\\.)+[a-zA-Z0-9](?:[a-zA-Z0-9\\-]*[a-zA-Z0-9])?$"}},u={render:o,args:{...s.args,type:`search`,icon:`magnifying-glass`,"append-input":`<mg-button slot="append-input" label="search">
