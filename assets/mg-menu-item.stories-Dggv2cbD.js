import{h as z}from"./index-BDiA27Xx.js";import{Y as C}from"./index.es-DYXCv77d.js";import{D as R}from"./mg-menu.conf-DGR1PezI.js";const H={component:"mg-menu-item",title:"Molecules/Menus/mg-menu-item",parameters:{actions:{handles:["item-loaded","item-updated"]}}},a=g=>z("mg-menu-item",{...C(g),innerHTML:g.slot}),e={render:a,args:{slot:'<span slot="label">My label</span>'}},n={render:a,args:{href:"./",...e.args}},s={render:a,args:{href:"./",target:"_blank",...e.args}},t={render:a,args:{...e.args,slot:'<span slot="label">My label</span><mg-icon icon="user" slot="image"></mg-icon>'}},r={render:a,args:{...e.args,slot:'<span slot="label">My label</span><mg-badge value="2" label="hello" slot="information"></mg-badge>'}},m={render:a,args:{...e.args,slot:'<span slot="label">My label</span><mg-badge value="2" label="hello" slot="information"></mg-badge><mg-icon icon="user" slot="image"></mg-icon>'}},o={render:a,args:{...e.args,"data-overflow-more":!0,"data-size":"medium",slot:'<span slot="label">My label</span>, <span slot="metadata">My metadata</span>'}},l={render:a,args:{...e.args,slot:`<span slot="label">My label</span>
