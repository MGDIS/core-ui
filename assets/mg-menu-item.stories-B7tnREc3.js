import{h as w}from"./index-BDiA27Xx.js";import{V as z}from"./index.es-BgKvlgMl.js";import{D as C}from"./mg-menu.conf-DGR1PezI.js";const O={component:"mg-menu-item",title:"Molecules/Menus/mg-menu-item",parameters:{actions:{handles:["item-loaded","item-updated"]}}},a=g=>w("mg-menu-item",{...z(g),innerHTML:g.slot}),e={render:a,args:{slot:'<span slot="label">My label</span>'}},n={render:a,args:{href:"./",...e.args}},s={render:a,args:{href:"./",target:"_blank",...e.args}},t={render:a,args:{...e.args,slot:'<span slot="label">My label</span><mg-icon icon="user" slot="image"></mg-icon>'}},r={render:a,args:{...e.args,slot:'<span slot="label">My label</span><mg-badge value="2" label="hello" slot="information"></mg-badge>'}},m={render:a,args:{...e.args,slot:'<span slot="label">My label</span><mg-badge value="2" label="hello" slot="information"></mg-badge><mg-icon icon="user" slot="image"></mg-icon>'}},o={render:a,args:{...e.args,"data-overflow-more":!0,"data-size":"medium",slot:'<span slot="label">My label</span>, <span slot="metadata">My metadata</span>'}},l={render:a,args:{...e.args,slot:`<span slot="label">My label</span>
