import{h as u}from"./index-D8HVAEo-.js";import{f as c}from"./iframe-DKP2BhGE.js";import{d}from"./mg-menu.conf-D_q0UiHu.js";import"./preload-helper-PPVm8Dsz.js";const f={component:"mg-menu-item",title:"Molecules/Menus/mg-menu-item",parameters:{actions:{handles:["item-loaded","item-updated"]}}},a=n=>u("mg-menu",{label:"demo"},u("mg-menu-item",{...c(n,{status:"visible"},["","image","information","label","metadata"]),innerHTML:`${n[""]}${n.image}${n.information}${n.label}${n.metadata}`})),e={render:a,args:{identifier:"identifier",href:void 0,target:void 0,status:void 0,expanded:!1,isIcon:!1,"":"",image:"",information:"",label:'<span slot="label">My label</span>',metadata:""}},s={render:a,args:{...e.args,href:"./"}},t={render:a,args:{...s.args,target:"_blank"}},r={render:a,args:{...e.args,label:'<span slot="label">My label</span>',image:'<mg-icon icon="user" slot="image"></mg-icon>'}},m={render:a,args:{...e.args,label:'<span slot="label">My label</span>',image:'<mg-icon icon="user" slot="image"></mg-icon>',isIcon:!0}},o={render:a,args:{...e.args,label:'<span slot="label">My label</span>',information:'<mg-badge value="2" label="hello" slot="information"></mg-badge>'}},l={render:a,args:{...e.args,label:'<span slot="label">My label</span>',information:'<mg-badge value="2" label="hello" slot="information"></mg-badge>',image:'<mg-icon icon="user" slot="image"></mg-icon>'}},i={render:a,args:{...e.args,label:'<span slot="label">My label</span>',metadata:'<span slot="metadata">My metadata</span>'}},g={render:a,args:{...e.args,expanded:!0,label:'<span slot="label">My label</span>',"":`<mg-menu direction="${d.VERTICAL}" label="submenu">
