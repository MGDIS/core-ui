const __vite__fileDeps=["./mg-action-more_36.entry-D7TYZVBn.js","./index-138ea119-UTpGOzAz.js","./_commonjsHelpers-BosuxZz1.js","./v4-CQkTLCs1.js","./index.es-DYXCv77d.js","./iframe-DORQFaj8.js","./mg-loader.entry-Se-AoS-9.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import{c as W,g as bl,a as Tl}from"./_commonjsHelpers-BosuxZz1.js";import{v as xl}from"./v4-CQkTLCs1.js";import{V as wl,Z as $l}from"./index.es-DYXCv77d.js";import{_ as pt}from"./iframe-DORQFaj8.js";var Be={},ce=function(e){return e&&e.Math===Math&&e},A=ce(typeof globalThis=="object"&&globalThis)||ce(typeof window=="object"&&window)||ce(typeof self=="object"&&self)||ce(typeof W=="object"&&W)||ce(typeof W=="object"&&W)||function(){return this}()||Function("return this")(),mn={},$=function(e){try{return!!e()}catch{return!0}},kl=$,C=!kl(function(){return Object.defineProperty({},1,{get:function(){return 7}})[1]!==7}),Sl=$,Ye=!Sl(function(){var e=(function(){}).bind();return typeof e!="function"||e.hasOwnProperty("prototype")}),Il=Ye,Ae=Function.prototype.call,z=Il?Ae.bind(Ae):function(){return Ae.apply(Ae,arguments)},Mo={},Oo={}.propertyIsEnumerable,Co=Object.getOwnPropertyDescriptor,Al=Co&&!Oo.call({1:2},1);Mo.f=Al?function(t){var n=Co(this,t);return!!n&&n.enumerable}:Oo;var Je=function(e,t){return{enumerable:!(e&1),configurable:!(e&2),writable:!(e&4),value:t}},Lo=Ye,Ro=Function.prototype,Nt=Ro.call,El=Lo&&Ro.bind.bind(Nt,Nt),S=Lo?El:function(e){return function(){return Nt.apply(e,arguments)}},_o=S,Pl=_o({}.toString),Dl=_o("".slice),Y=function(e){return Dl(Pl(e),8,-1)},ql=S,Ml=$,Ol=Y,dt=Object,Cl=ql("".split),Ll=Ml(function(){return!dt("z").propertyIsEnumerable(0)})?function(e){return Ol(e)==="String"?Cl(e,""):dt(e)}:dt,re=function(e){return e==null},Rl=re,_l=TypeError,Xe=function(e){if(Rl(e))throw new _l("Can't call method on "+e);return e},zl=Ll,jl=Xe,le=function(e){return zl(jl(e))},Wt=typeof document=="object"&&document.all,Bl=typeof Wt>"u"&&Wt!==void 0,zo={all:Wt,IS_HTMLDDA:Bl},jo=zo,Hl=jo.all,k=jo.IS_HTMLDDA?function(e){return typeof e=="function"||e===Hl}:function(e){return typeof e=="function"},Jn=k,Bo=zo,Fl=Bo.all,q=Bo.IS_HTMLDDA?function(e){return typeof e=="object"?e!==null:Jn(e)||e===Fl}:function(e){return typeof e=="object"?e!==null:Jn(e)},gt=A,Vl=k,Nl=function(e){return Vl(e)?e:void 0},Te=function(e,t){return arguments.length<2?Nl(gt[e]):gt[e]&&gt[e][t]},Wl=S,fn=Wl({}.isPrototypeOf),Ul=typeof navigator<"u"&&String(navigator.userAgent)||"",Ho=A,mt=Ul,Xn=Ho.process,Zn=Ho.Deno,Qn=Xn&&Xn.versions||Zn&&Zn.version,ea=Qn&&Qn.v8,M,He;ea&&(M=ea.split("."),He=M[0]>0&&M[0]<4?1:+(M[0]+M[1]));!He&&mt&&(M=mt.match(/Edge\/(\d+)/),(!M||M[1]>=74)&&(M=mt.match(/Chrome\/(\d+)/),M&&(He=+M[1])));var vn=He,ta=vn,Gl=$,Kl=A,Yl=Kl.String,Fo=!!Object.getOwnPropertySymbols&&!Gl(function(){var e=Symbol("symbol detection");return!Yl(e)||!(Object(e)instanceof Symbol)||!Symbol.sham&&ta&&ta<41}),Jl=Fo,Vo=Jl&&!Symbol.sham&&typeof Symbol.iterator=="symbol",Xl=Te,Zl=k,Ql=fn,ei=Vo,ti=Object,No=ei?function(e){return typeof e=="symbol"}:function(e){var t=Xl("Symbol");return Zl(t)&&Ql(t.prototype,ti(e))},ni=String,yn=function(e){try{return ni(e)}catch{return"Object"}},ai=k,oi=yn,ri=TypeError,Ze=function(e){if(ai(e))return e;throw new ri(oi(e)+" is not a function")},li=Ze,ii=re,Qe=function(e,t){var n=e[t];return ii(n)?void 0:li(n)},ft=z,vt=k,yt=q,si=TypeError,ci=function(e,t){var n,a;if(t==="string"&&vt(n=e.toString)&&!yt(a=ft(n,e))||vt(n=e.valueOf)&&!yt(a=ft(n,e))||t!=="string"&&vt(n=e.toString)&&!yt(a=ft(n,e)))return a;throw new si("Can't convert object to primitive value")},Wo={exports:{}},na=A,ui=Object.defineProperty,hn=function(e,t){try{ui(na,e,{value:t,configurable:!0,writable:!0})}catch{na[e]=t}return t},pi=A,di=hn,aa="__core-js_shared__",gi=pi[aa]||di(aa,{}),bn=gi,oa=bn;(Wo.exports=function(e,t){return oa[e]||(oa[e]=t!==void 0?t:{})})("versions",[]).push({version:"3.34.0",mode:"global",copyright:"© 2014-2023 Denis Pushkarev (zloirock.ru)",license:"https://github.com/zloirock/core-js/blob/v3.34.0/LICENSE",source:"https://github.com/zloirock/core-js"});var Tn=Wo.exports,mi=Xe,fi=Object,et=function(e){return fi(mi(e))},vi=S,yi=et,hi=vi({}.hasOwnProperty),j=Object.hasOwn||function(t,n){return hi(yi(t),n)},bi=S,Ti=0,xi=Math.random(),wi=bi(1 .toString),xn=function(e){return"Symbol("+(e===void 0?"":e)+")_"+wi(++Ti+xi,36)},$i=A,ki=Tn,ra=j,Si=xn,Ii=Fo,Ai=Vo,ae=$i.Symbol,ht=ki("wks"),Ei=Ai?ae.for||ae:ae&&ae.withoutSetter||Si,I=function(e){return ra(ht,e)||(ht[e]=Ii&&ra(ae,e)?ae[e]:Ei("Symbol."+e)),ht[e]},Pi=z,la=q,ia=No,Di=Qe,qi=ci,Mi=I,Oi=TypeError,Ci=Mi("toPrimitive"),Li=function(e,t){if(!la(e)||ia(e))return e;var n=Di(e,Ci),a;if(n){if(t===void 0&&(t="default"),a=Pi(n,e,t),!la(a)||ia(a))return a;throw new Oi("Can't convert object to primitive value")}return t===void 0&&(t="number"),qi(e,t)},Ri=Li,_i=No,wn=function(e){var t=Ri(e,"string");return _i(t)?t:t+""},zi=A,sa=q,Ut=zi.document,ji=sa(Ut)&&sa(Ut.createElement),$n=function(e){return ji?Ut.createElement(e):{}},Bi=C,Hi=$,Fi=$n,Uo=!Bi&&!Hi(function(){return Object.defineProperty(Fi("div"),"a",{get:function(){return 7}}).a!==7}),Vi=C,Ni=z,Wi=Mo,Ui=Je,Gi=le,Ki=wn,Yi=j,Ji=Uo,ca=Object.getOwnPropertyDescriptor;mn.f=Vi?ca:function(t,n){if(t=Gi(t),n=Ki(n),Ji)try{return ca(t,n)}catch{}if(Yi(t,n))return Ui(!Ni(Wi.f,t,n),t[n])};var L={},Xi=C,Zi=$,Go=Xi&&Zi(function(){return Object.defineProperty(function(){},"prototype",{value:42,writable:!1}).prototype!==42}),Qi=q,es=String,ts=TypeError,R=function(e){if(Qi(e))return e;throw new ts(es(e)+" is not an object")},ns=C,as=Uo,os=Go,Ee=R,ua=wn,rs=TypeError,bt=Object.defineProperty,ls=Object.getOwnPropertyDescriptor,Tt="enumerable",xt="configurable",wt="writable";L.f=ns?os?function(t,n,a){if(Ee(t),n=ua(n),Ee(a),typeof t=="function"&&n==="prototype"&&"value"in a&&wt in a&&!a[wt]){var o=ls(t,n);o&&o[wt]&&(t[n]=a.value,a={configurable:xt in a?a[xt]:o[xt],enumerable:Tt in a?a[Tt]:o[Tt],writable:!1})}return bt(t,n,a)}:bt:function(t,n,a){if(Ee(t),n=ua(n),Ee(a),as)try{return bt(t,n,a)}catch{}if("get"in a||"set"in a)throw new rs("Accessors not supported");return"value"in a&&(t[n]=a.value),t};var is=C,ss=L,cs=Je,xe=is?function(e,t,n){return ss.f(e,t,cs(1,n))}:function(e,t,n){return e[t]=n,e},Ko={exports:{}},Gt=C,us=j,Yo=Function.prototype,ps=Gt&&Object.getOwnPropertyDescriptor,kn=us(Yo,"name"),ds=kn&&(function(){}).name==="something",gs=kn&&(!Gt||Gt&&ps(Yo,"name").configurable),Jo={EXISTS:kn,PROPER:ds,CONFIGURABLE:gs},ms=S,fs=k,Kt=bn,vs=ms(Function.toString);fs(Kt.inspectSource)||(Kt.inspectSource=function(e){return vs(e)});var Xo=Kt.inspectSource,ys=A,hs=k,pa=ys.WeakMap,bs=hs(pa)&&/native code/.test(String(pa)),Ts=Tn,xs=xn,da=Ts("keys"),Sn=function(e){return da[e]||(da[e]=xs(e))},tt={},ws=bs,Zo=A,$s=q,ks=xe,$t=j,kt=bn,Ss=Sn,Is=tt,ga="Object already initialized",Yt=Zo.TypeError,As=Zo.WeakMap,Fe,ve,Ve,Es=function(e){return Ve(e)?ve(e):Fe(e,{})},Ps=function(e){return function(t){var n;if(!$s(t)||(n=ve(t)).type!==e)throw new Yt("Incompatible receiver, "+e+" required");return n}};if(ws||kt.state){var _=kt.state||(kt.state=new As);_.get=_.get,_.has=_.has,_.set=_.set,Fe=function(e,t){if(_.has(e))throw new Yt(ga);return t.facade=e,_.set(e,t),t},ve=function(e){return _.get(e)||{}},Ve=function(e){return _.has(e)}}else{var Z=Ss("state");Is[Z]=!0,Fe=function(e,t){if($t(e,Z))throw new Yt(ga);return t.facade=e,ks(e,Z,t),t},ve=function(e){return $t(e,Z)?e[Z]:{}},Ve=function(e){return $t(e,Z)}}var we={set:Fe,get:ve,has:Ve,enforce:Es,getterFor:Ps},In=S,Ds=$,qs=k,Pe=j,Jt=C,Ms=Jo.CONFIGURABLE,Os=Xo,Qo=we,Cs=Qo.enforce,Ls=Qo.get,ma=String,Le=Object.defineProperty,Rs=In("".slice),_s=In("".replace),zs=In([].join),js=Jt&&!Ds(function(){return Le(function(){},"length",{value:8}).length!==8}),Bs=String(String).split("String"),Hs=Ko.exports=function(e,t,n){Rs(ma(t),0,7)==="Symbol("&&(t="["+_s(ma(t),/^Symbol\(([^)]*)\)/,"$1")+"]"),n&&n.getter&&(t="get "+t),n&&n.setter&&(t="set "+t),(!Pe(e,"name")||Ms&&e.name!==t)&&(Jt?Le(e,"name",{value:t,configurable:!0}):e.name=t),js&&n&&Pe(n,"arity")&&e.length!==n.arity&&Le(e,"length",{value:n.arity});try{n&&Pe(n,"constructor")&&n.constructor?Jt&&Le(e,"prototype",{writable:!1}):e.prototype&&(e.prototype=void 0)}catch{}var a=Cs(e);return Pe(a,"source")||(a.source=zs(Bs,typeof t=="string"?t:"")),e};Function.prototype.toString=Hs(function(){return qs(this)&&Ls(this).source||Os(this)},"toString");var er=Ko.exports,Fs=k,Vs=L,Ns=er,Ws=hn,J=function(e,t,n,a){a||(a={});var o=a.enumerable,l=a.name!==void 0?a.name:t;if(Fs(n)&&Ns(n,l,a),a.global)o?e[t]=n:Ws(t,n);else{try{a.unsafe?e[t]&&(o=!0):delete e[t]}catch{}o?e[t]=n:Vs.f(e,t,{value:n,enumerable:!1,configurable:!a.nonConfigurable,writable:!a.nonWritable})}return e},nt={},Us=Math.ceil,Gs=Math.floor,Ks=Math.trunc||function(t){var n=+t;return(n>0?Gs:Us)(n)},Ys=Ks,at=function(e){var t=+e;return t!==t||t===0?0:Ys(t)},Js=at,Xs=Math.max,Zs=Math.min,tr=function(e,t){var n=Js(e);return n<0?Xs(n+t,0):Zs(n,t)},Qs=at,ec=Math.min,nr=function(e){return e>0?ec(Qs(e),9007199254740991):0},tc=nr,ot=function(e){return tc(e.length)},nc=le,ac=tr,oc=ot,fa=function(e){return function(t,n,a){var o=nc(t),l=oc(o),r=ac(a,l),c;if(e&&n!==n){for(;l>r;)if(c=o[r++],c!==c)return!0}else for(;l>r;r++)if((e||r in o)&&o[r]===n)return e||r||0;return!e&&-1}},rc={includes:fa(!0),indexOf:fa(!1)},lc=S,St=j,ic=le,sc=rc.indexOf,cc=tt,va=lc([].push),ar=function(e,t){var n=ic(e),a=0,o=[],l;for(l in n)!St(cc,l)&&St(n,l)&&va(o,l);for(;t.length>a;)St(n,l=t[a++])&&(~sc(o,l)||va(o,l));return o},An=["constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"],uc=ar,pc=An,dc=pc.concat("length","prototype");nt.f=Object.getOwnPropertyNames||function(t){return uc(t,dc)};var or={};or.f=Object.getOwnPropertySymbols;var gc=Te,mc=S,fc=nt,vc=or,yc=R,hc=mc([].concat),bc=gc("Reflect","ownKeys")||function(t){var n=fc.f(yc(t)),a=vc.f;return a?hc(n,a(t)):n},ya=j,Tc=bc,xc=mn,wc=L,$c=function(e,t,n){for(var a=Tc(t),o=wc.f,l=xc.f,r=0;r<a.length;r++){var c=a[r];!ya(e,c)&&!(n&&ya(n,c))&&o(e,c,l(t,c))}},kc=$,Sc=k,Ic=/#|\.prototype\./,$e=function(e,t){var n=Ec[Ac(e)];return n===Dc?!0:n===Pc?!1:Sc(t)?kc(t):!!t},Ac=$e.normalize=function(e){return String(e).replace(Ic,".").toLowerCase()},Ec=$e.data={},Pc=$e.NATIVE="N",Dc=$e.POLYFILL="P",rr=$e,It=A,qc=mn.f,Mc=xe,Oc=J,Cc=hn,Lc=$c,Rc=rr,ke=function(e,t){var n=e.target,a=e.global,o=e.stat,l,r,c,i,u,s;if(a?r=It:o?r=It[n]||Cc(n,{}):r=(It[n]||{}).prototype,r)for(c in t){if(u=t[c],e.dontCallGetSet?(s=qc(r,c),i=s&&s.value):i=r[c],l=Rc(a?c:n+(o?".":"#")+c,e.forced),!l&&i!==void 0){if(typeof u==typeof i)continue;Lc(u,i)}(e.sham||i&&i.sham)&&Mc(u,"sham",!0),Oc(r,c,u,e)}},_c=Y,lr=Array.isArray||function(t){return _c(t)==="Array"},zc=TypeError,jc=9007199254740991,Bc=function(e){if(e>jc)throw zc("Maximum allowed index exceeded");return e},Hc=wn,Fc=L,Vc=Je,ir=function(e,t,n){var a=Hc(t);a in e?Fc.f(e,a,Vc(0,n)):e[a]=n},Nc=I,Wc=Nc("toStringTag"),sr={};sr[Wc]="z";var En=String(sr)==="[object z]",Uc=En,Gc=k,Re=Y,Kc=I,Yc=Kc("toStringTag"),Jc=Object,Xc=Re(function(){return arguments}())==="Arguments",Zc=function(e,t){try{return e[t]}catch{}},rt=Uc?Re:function(e){var t,n,a;return e===void 0?"Undefined":e===null?"Null":typeof(n=Zc(t=Jc(e),Yc))=="string"?n:Xc?Re(t):(a=Re(t))==="Object"&&Gc(t.callee)?"Arguments":a},Qc=S,eu=$,cr=k,tu=rt,nu=Te,au=Xo,ur=function(){},ou=[],pr=nu("Reflect","construct"),Pn=/^\s*(?:class|function)\b/,ru=Qc(Pn.exec),lu=!Pn.test(ur),ue=function(t){if(!cr(t))return!1;try{return pr(ur,ou,t),!0}catch{return!1}},dr=function(t){if(!cr(t))return!1;switch(tu(t)){case"AsyncFunction":case"GeneratorFunction":case"AsyncGeneratorFunction":return!1}try{return lu||!!ru(Pn,au(t))}catch{return!0}};dr.sham=!0;var iu=!pr||eu(function(){var e;return ue(ue.call)||!ue(Object)||!ue(function(){e=!0})||e})?dr:ue,ha=lr,su=iu,cu=q,uu=I,pu=uu("species"),ba=Array,du=function(e){var t;return ha(e)&&(t=e.constructor,su(t)&&(t===ba||ha(t.prototype))?t=void 0:cu(t)&&(t=t[pu],t===null&&(t=void 0))),t===void 0?ba:t},gu=du,mu=function(e,t){return new(gu(e))(t===0?0:t)},fu=$,vu=I,yu=vn,hu=vu("species"),bu=function(e){return yu>=51||!fu(function(){var t=[],n=t.constructor={};return n[hu]=function(){return{foo:1}},t[e](Boolean).foo!==1})},Tu=ke,xu=$,wu=lr,$u=q,ku=et,Su=ot,Ta=Bc,xa=ir,Iu=mu,Au=bu,Eu=I,Pu=vn,gr=Eu("isConcatSpreadable"),Du=Pu>=51||!xu(function(){var e=[];return e[gr]=!1,e.concat()[0]!==e}),qu=function(e){if(!$u(e))return!1;var t=e[gr];return t!==void 0?!!t:wu(e)},Mu=!Du||!Au("concat");Tu({target:"Array",proto:!0,arity:1,forced:Mu},{concat:function(t){var n=ku(this),a=Iu(n,0),o=0,l,r,c,i,u;for(l=-1,c=arguments.length;l<c;l++)if(u=l===-1?n:arguments[l],qu(u))for(i=Su(u),Ta(o+i),r=0;r<i;r++,o++)r in u&&xa(a,o,u[r]);else Ta(o+1),xa(a,o++,u);return a.length=o,a}});var mr={},Ou=ar,Cu=An,Lu=Object.keys||function(t){return Ou(t,Cu)},Ru=C,_u=Go,zu=L,ju=R,Bu=le,Hu=Lu;mr.f=Ru&&!_u?Object.defineProperties:function(t,n){ju(t);for(var a=Bu(n),o=Hu(n),l=o.length,r=0,c;l>r;)zu.f(t,c=o[r++],a[c]);return t};var Fu=Te,Vu=Fu("document","documentElement"),Nu=R,Wu=mr,wa=An,Uu=tt,Gu=Vu,Ku=$n,Yu=Sn,$a=">",ka="<",Xt="prototype",Zt="script",fr=Yu("IE_PROTO"),At=function(){},vr=function(e){return ka+Zt+$a+e+ka+"/"+Zt+$a},Sa=function(e){e.write(vr("")),e.close();var t=e.parentWindow.Object;return e=null,t},Ju=function(){var e=Ku("iframe"),t="java"+Zt+":",n;return e.style.display="none",Gu.appendChild(e),e.src=String(t),n=e.contentWindow.document,n.open(),n.write(vr("document.F=Object")),n.close(),n.F},De,_e=function(){try{De=new ActiveXObject("htmlfile")}catch{}_e=typeof document<"u"?document.domain&&De?Sa(De):Ju():Sa(De);for(var e=wa.length;e--;)delete _e[Xt][wa[e]];return _e()};Uu[fr]=!0;var lt=Object.create||function(t,n){var a;return t!==null?(At[Xt]=Nu(t),a=new At,At[Xt]=null,a[fr]=t):a=_e(),n===void 0?a:Wu.f(a,n)},Xu=I,Zu=lt,Qu=L.f,Qt=Xu("unscopables"),en=Array.prototype;en[Qt]===void 0&&Qu(en,Qt,{configurable:!0,value:Zu(null)});var ep=function(e){en[Qt][e]=!0},Se={},tp=$,np=!tp(function(){function e(){}return e.prototype.constructor=null,Object.getPrototypeOf(new e)!==e.prototype}),ap=j,op=k,rp=et,lp=Sn,ip=np,Ia=lp("IE_PROTO"),tn=Object,sp=tn.prototype,yr=ip?tn.getPrototypeOf:function(e){var t=rp(e);if(ap(t,Ia))return t[Ia];var n=t.constructor;return op(n)&&t instanceof n?n.prototype:t instanceof tn?sp:null},cp=$,up=k,pp=q,Aa=yr,dp=J,gp=I,nn=gp("iterator"),hr=!1,K,Et,Pt;[].keys&&(Pt=[].keys(),"next"in Pt?(Et=Aa(Aa(Pt)),Et!==Object.prototype&&(K=Et)):hr=!0);var mp=!pp(K)||cp(function(){var e={};return K[nn].call(e)!==e});mp&&(K={});up(K[nn])||dp(K,nn,function(){return this});var br={IteratorPrototype:K,BUGGY_SAFARI_ITERATORS:hr},fp=L.f,vp=j,yp=I,Ea=yp("toStringTag"),it=function(e,t,n){e&&!n&&(e=e.prototype),e&&!vp(e,Ea)&&fp(e,Ea,{configurable:!0,value:t})},hp=br.IteratorPrototype,bp=lt,Tp=Je,xp=it,wp=Se,$p=function(){return this},kp=function(e,t,n,a){var o=t+" Iterator";return e.prototype=bp(hp,{next:Tp(+!a,n)}),xp(e,o,!1),wp[o]=$p,e},Sp=S,Ip=Ze,Ap=function(e,t,n){try{return Sp(Ip(Object.getOwnPropertyDescriptor(e,t)[n]))}catch{}},Ep=k,Pp=String,Dp=TypeError,qp=function(e){if(typeof e=="object"||Ep(e))return e;throw new Dp("Can't set "+Pp(e)+" as a prototype")},Mp=Ap,Op=R,Cp=qp,Tr=Object.setPrototypeOf||("__proto__"in{}?function(){var e=!1,t={},n;try{n=Mp(Object.prototype,"__proto__","set"),n(t,[]),e=t instanceof Array}catch{}return function(o,l){return Op(o),Cp(l),e?n(o,l):o.__proto__=l,o}}():void 0),Lp=ke,Rp=z,xr=Jo,_p=k,zp=kp,Pa=yr,Da=Tr,jp=it,Bp=xe,Dt=J,Hp=I,Fp=Se,wr=br,Vp=xr.PROPER,Np=xr.CONFIGURABLE,qa=wr.IteratorPrototype,qe=wr.BUGGY_SAFARI_ITERATORS,pe=Hp("iterator"),Ma="keys",de="values",Oa="entries",Wp=function(){return this},Dn=function(e,t,n,a,o,l,r){zp(n,t,a);var c=function(m){if(m===o&&d)return d;if(!qe&&m&&m in s)return s[m];switch(m){case Ma:return function(){return new n(this,m)};case de:return function(){return new n(this,m)};case Oa:return function(){return new n(this,m)}}return function(){return new n(this)}},i=t+" Iterator",u=!1,s=e.prototype,p=s[pe]||s["@@iterator"]||o&&s[o],d=!qe&&p||c(o),g=t==="Array"&&s.entries||p,v,y,T;if(g&&(v=Pa(g.call(new e)),v!==Object.prototype&&v.next&&(Pa(v)!==qa&&(Da?Da(v,qa):_p(v[pe])||Dt(v,pe,Wp)),jp(v,i,!0))),Vp&&o===de&&p&&p.name!==de&&(Np?Bp(s,"name",de):(u=!0,d=function(){return Rp(p,this)})),o)if(y={values:c(de),keys:l?d:c(Ma),entries:c(Oa)},r)for(T in y)(qe||u||!(T in s))&&Dt(s,T,y[T]);else Lp({target:t,proto:!0,forced:qe||u},y);return s[pe]!==d&&Dt(s,pe,d,{name:o}),Fp[t]=d,y},qn=function(e,t){return{value:e,done:t}},Up=le,Mn=ep,Ca=Se,$r=we,Gp=L.f,Kp=Dn,Me=qn,Yp=C,kr="Array Iterator",Jp=$r.set,Xp=$r.getterFor(kr),Zp=Kp(Array,"Array",function(e,t){Jp(this,{type:kr,target:Up(e),index:0,kind:t})},function(){var e=Xp(this),t=e.target,n=e.index++;if(!t||n>=t.length)return e.target=void 0,Me(void 0,!0);switch(e.kind){case"keys":return Me(n,!1);case"values":return Me(t[n],!1)}return Me([n,t[n]],!1)},"values"),La=Ca.Arguments=Ca.Array;Mn("keys");Mn("values");Mn("entries");if(Yp&&La.name!=="values")try{Gp(La,"name",{value:"values"})}catch{}var Qp=En,ed=rt,td=Qp?{}.toString:function(){return"[object "+ed(this)+"]"},nd=En,ad=J,od=td;nd||ad(Object.prototype,"toString",od,{unsafe:!0});var Sr={exports:{}},Ir={},Ra=tr,rd=ot,ld=ir,id=Array,sd=Math.max,cd=function(e,t,n){for(var a=rd(e),o=Ra(t,a),l=Ra(n===void 0?a:n,a),r=id(sd(l-o,0)),c=0;o<l;o++,c++)ld(r,c,e[o]);return r.length=c,r},ud=Y,pd=le,Ar=nt.f,dd=cd,Er=typeof window=="object"&&window&&Object.getOwnPropertyNames?Object.getOwnPropertyNames(window):[],gd=function(e){try{return Ar(e)}catch{return dd(Er)}};Ir.f=function(t){return Er&&ud(t)==="Window"?gd(t):Ar(pd(t))};var md=$,fd=md(function(){if(typeof ArrayBuffer=="function"){var e=new ArrayBuffer(8);Object.isExtensible(e)&&Object.defineProperty(e,"a",{value:8})}}),vd=$,yd=q,hd=Y,_a=fd,ze=Object.isExtensible,bd=vd(function(){ze(1)}),Td=bd||_a?function(t){return!yd(t)||_a&&hd(t)==="ArrayBuffer"?!1:ze?ze(t):!0}:ze,xd=$,wd=!xd(function(){return Object.isExtensible(Object.preventExtensions({}))}),$d=ke,kd=S,Sd=tt,Id=q,On=j,Ad=L.f,za=nt,Ed=Ir,Cn=Td,Pd=xn,Dd=wd,Pr=!1,F=Pd("meta"),qd=0,Ln=function(e){Ad(e,F,{value:{objectID:"O"+qd++,weakData:{}}})},Md=function(e,t){if(!Id(e))return typeof e=="symbol"?e:(typeof e=="string"?"S":"P")+e;if(!On(e,F)){if(!Cn(e))return"F";if(!t)return"E";Ln(e)}return e[F].objectID},Od=function(e,t){if(!On(e,F)){if(!Cn(e))return!0;if(!t)return!1;Ln(e)}return e[F].weakData},Cd=function(e){return Dd&&Pr&&Cn(e)&&!On(e,F)&&Ln(e),e},Ld=function(){Rd.enable=function(){},Pr=!0;var e=za.f,t=kd([].splice),n={};n[F]=1,e(n).length&&(za.f=function(a){for(var o=e(a),l=0,r=o.length;l<r;l++)if(o[l]===F){t(o,l,1);break}return o},$d({target:"Object",stat:!0,forced:!0},{getOwnPropertyNames:Ed.f}))},Rd=Sr.exports={enable:Ld,fastKey:Md,getWeakData:Od,onFreeze:Cd};Sd[F]=!0;var Dr=Sr.exports,_d=Y,zd=S,qr=function(e){if(_d(e)==="Function")return zd(e)},ja=qr,jd=Ze,Bd=Ye,Hd=ja(ja.bind),Mr=function(e,t){return jd(e),t===void 0?e:Bd?Hd(e,t):function(){return e.apply(t,arguments)}},Fd=I,Vd=Se,Nd=Fd("iterator"),Wd=Array.prototype,Ud=function(e){return e!==void 0&&(Vd.Array===e||Wd[Nd]===e)},Gd=rt,Ba=Qe,Kd=re,Yd=Se,Jd=I,Xd=Jd("iterator"),Or=function(e){if(!Kd(e))return Ba(e,Xd)||Ba(e,"@@iterator")||Yd[Gd(e)]},Zd=z,Qd=Ze,eg=R,tg=yn,ng=Or,ag=TypeError,og=function(e,t){var n=arguments.length<2?ng(e):t;if(Qd(n))return eg(Zd(n,e));throw new ag(tg(e)+" is not iterable")},rg=z,Ha=R,lg=Qe,ig=function(e,t,n){var a,o;Ha(e);try{if(a=lg(e,"return"),!a){if(t==="throw")throw n;return n}a=rg(a,e)}catch(l){o=!0,a=l}if(t==="throw")throw n;if(o)throw a;return Ha(a),n},sg=Mr,cg=z,ug=R,pg=yn,dg=Ud,gg=ot,Fa=fn,mg=og,fg=Or,Va=ig,vg=TypeError,je=function(e,t){this.stopped=e,this.result=t},Na=je.prototype,Cr=function(e,t,n){var a=n&&n.that,o=!!(n&&n.AS_ENTRIES),l=!!(n&&n.IS_RECORD),r=!!(n&&n.IS_ITERATOR),c=!!(n&&n.INTERRUPTED),i=sg(t,a),u,s,p,d,g,v,y,T=function(f){return u&&Va(u,"normal",f),new je(!0,f)},m=function(f){return o?(ug(f),c?i(f[0],f[1],T):i(f[0],f[1])):c?i(f,T):i(f)};if(l)u=e.iterator;else if(r)u=e;else{if(s=fg(e),!s)throw new vg(pg(e)+" is not iterable");if(dg(s)){for(p=0,d=gg(e);d>p;p++)if(g=m(e[p]),g&&Fa(Na,g))return g;return new je(!1)}u=mg(e,s)}for(v=l?e.next:u.next;!(y=cg(v,u)).done;){try{g=m(y.value)}catch(f){Va(u,"throw",f)}if(typeof g=="object"&&g&&Fa(Na,g))return g}return new je(!1)},yg=fn,hg=TypeError,Lr=function(e,t){if(yg(t,e))return e;throw new hg("Incorrect invocation")},bg=I,Rr=bg("iterator"),_r=!1;try{var Tg=0,Wa={next:function(){return{done:!!Tg++}},return:function(){_r=!0}};Wa[Rr]=function(){return this},Array.from(Wa,function(){throw 2})}catch{}var xg=function(e,t){try{if(!t&&!_r)return!1}catch{return!1}var n=!1;try{var a={};a[Rr]=function(){return{next:function(){return{done:n=!0}}}},e(a)}catch{}return n},wg=k,$g=q,Ua=Tr,kg=function(e,t,n){var a,o;return Ua&&wg(a=t.constructor)&&a!==n&&$g(o=a.prototype)&&o!==n.prototype&&Ua(e,o),e},Sg=ke,Ig=A,Ag=S,Ga=rr,Eg=J,Pg=Dr,Dg=Cr,qg=Lr,Mg=k,Og=re,qt=q,Mt=$,Cg=xg,Lg=it,Rg=kg,_g=function(e,t,n){var a=e.indexOf("Map")!==-1,o=e.indexOf("Weak")!==-1,l=a?"set":"add",r=Ig[e],c=r&&r.prototype,i=r,u={},s=function(m){var f=Ag(c[m]);Eg(c,m,m==="add"?function(b){return f(this,b===0?0:b),this}:m==="delete"?function(h){return o&&!qt(h)?!1:f(this,h===0?0:h)}:m==="get"?function(b){return o&&!qt(b)?void 0:f(this,b===0?0:b)}:m==="has"?function(b){return o&&!qt(b)?!1:f(this,b===0?0:b)}:function(b,x){return f(this,b===0?0:b,x),this})},p=Ga(e,!Mg(r)||!(o||c.forEach&&!Mt(function(){new r().entries().next()})));if(p)i=n.getConstructor(t,e,a,l),Pg.enable();else if(Ga(e,!0)){var d=new i,g=d[l](o?{}:-0,1)!==d,v=Mt(function(){d.has(1)}),y=Cg(function(m){new r(m)}),T=!o&&Mt(function(){for(var m=new r,f=5;f--;)m[l](f,f);return!m.has(-0)});y||(i=t(function(m,f){qg(m,c);var h=Rg(new r,m,i);return Og(f)||Dg(f,h[l],{that:h,AS_ENTRIES:a}),h}),i.prototype=c,c.constructor=i),(v||T)&&(s("delete"),s("has"),a&&s("get")),(T||g)&&s(l),o&&c.clear&&delete c.clear}return u[e]=i,Sg({global:!0,constructor:!0,forced:i!==r},u),Lg(i,e),o||n.setStrong(i,e,a),i},Ka=er,zg=L,zr=function(e,t,n){return n.get&&Ka(n.get,t,{getter:!0}),n.set&&Ka(n.set,t,{setter:!0}),zg.f(e,t,n)},jg=J,Bg=function(e,t,n){for(var a in t)jg(e,a,t[a],n);return e},Hg=Te,Fg=zr,Vg=I,Ng=C,Ya=Vg("species"),Wg=function(e){var t=Hg(e);Ng&&t&&!t[Ya]&&Fg(t,Ya,{configurable:!0,get:function(){return this}})},Ug=lt,Gg=zr,Ja=Bg,Kg=Mr,Yg=Lr,Jg=re,Xg=Cr,Zg=Dn,Oe=qn,Qg=Wg,ge=C,Xa=Dr.fastKey,jr=we,Za=jr.set,Ot=jr.getterFor,em={getConstructor:function(e,t,n,a){var o=e(function(u,s){Yg(u,l),Za(u,{type:t,index:Ug(null),first:void 0,last:void 0,size:0}),ge||(u.size=0),Jg(s)||Xg(s,u[a],{that:u,AS_ENTRIES:n})}),l=o.prototype,r=Ot(t),c=function(u,s,p){var d=r(u),g=i(u,s),v,y;return g?g.value=p:(d.last=g={index:y=Xa(s,!0),key:s,value:p,previous:v=d.last,next:void 0,removed:!1},d.first||(d.first=g),v&&(v.next=g),ge?d.size++:u.size++,y!=="F"&&(d.index[y]=g)),u},i=function(u,s){var p=r(u),d=Xa(s),g;if(d!=="F")return p.index[d];for(g=p.first;g;g=g.next)if(g.key===s)return g};return Ja(l,{clear:function(){for(var s=this,p=r(s),d=p.index,g=p.first;g;)g.removed=!0,g.previous&&(g.previous=g.previous.next=void 0),delete d[g.index],g=g.next;p.first=p.last=void 0,ge?p.size=0:s.size=0},delete:function(u){var s=this,p=r(s),d=i(s,u);if(d){var g=d.next,v=d.previous;delete p.index[d.index],d.removed=!0,v&&(v.next=g),g&&(g.previous=v),p.first===d&&(p.first=g),p.last===d&&(p.last=v),ge?p.size--:s.size--}return!!d},forEach:function(s){for(var p=r(this),d=Kg(s,arguments.length>1?arguments[1]:void 0),g;g=g?g.next:p.first;)for(d(g.value,g.key,this);g&&g.removed;)g=g.previous},has:function(s){return!!i(this,s)}}),Ja(l,n?{get:function(s){var p=i(this,s);return p&&p.value},set:function(s,p){return c(this,s===0?0:s,p)}}:{add:function(s){return c(this,s=s===0?0:s,s)}}),ge&&Gg(l,"size",{configurable:!0,get:function(){return r(this).size}}),o},setStrong:function(e,t,n){var a=t+" Iterator",o=Ot(t),l=Ot(a);Zg(e,t,function(r,c){Za(this,{type:a,target:r,state:o(r),kind:c,last:void 0})},function(){for(var r=l(this),c=r.kind,i=r.last;i&&i.removed;)i=i.previous;return!r.target||!(r.last=i=i?i.next:r.state.first)?(r.target=void 0,Oe(void 0,!0)):Oe(c==="keys"?i.key:c==="values"?i.value:[i.key,i.value],!1)},n?"entries":"values",!n,!0),Qg(t)}},tm=_g,nm=em;tm("Set",function(e){return function(){return e(this,arguments.length?arguments[0]:void 0)}},nm);var am=rt,om=String,st=function(e){if(am(e)==="Symbol")throw new TypeError("Cannot convert a Symbol value to a string");return om(e)},Rn=S,rm=at,lm=st,im=Xe,sm=Rn("".charAt),Qa=Rn("".charCodeAt),cm=Rn("".slice),eo=function(e){return function(t,n){var a=lm(im(t)),o=rm(n),l=a.length,r,c;return o<0||o>=l?e?"":void 0:(r=Qa(a,o),r<55296||r>56319||o+1===l||(c=Qa(a,o+1))<56320||c>57343?e?sm(a,o):r:e?cm(a,o,o+2):(r-55296<<10)+(c-56320)+65536)}},Br={codeAt:eo(!1),charAt:eo(!0)},um=Br.charAt,pm=st,Hr=we,dm=Dn,to=qn,Fr="String Iterator",gm=Hr.set,mm=Hr.getterFor(Fr);dm(String,"String",function(e){gm(this,{type:Fr,string:pm(e),index:0})},function(){var t=mm(this),n=t.string,a=t.index,o;return a>=n.length?to(void 0,!0):(o=um(n,a),t.index+=o.length,to(o,!1))});var fm={CSSRuleList:0,CSSStyleDeclaration:0,CSSValueList:0,ClientRectList:0,DOMRectList:0,DOMStringList:0,DOMTokenList:1,DataTransferItemList:0,FileList:0,HTMLAllCollection:0,HTMLCollection:0,HTMLFormElement:0,HTMLSelectElement:0,MediaList:0,MimeTypeArray:0,NamedNodeMap:0,NodeList:1,PaintRequestList:0,Plugin:0,PluginArray:0,SVGLengthList:0,SVGNumberList:0,SVGPathSegList:0,SVGPointList:0,SVGStringList:0,SVGTransformList:0,SourceBufferList:0,StyleSheetList:0,TextTrackCueList:0,TextTrackList:0,TouchList:0},vm=$n,Ct=vm("span").classList,no=Ct&&Ct.constructor&&Ct.constructor.prototype,ym=no===Object.prototype?void 0:no,ao=A,Vr=fm,hm=ym,me=Zp,oo=xe,bm=it,Tm=I,Lt=Tm("iterator"),Rt=me.values,Nr=function(e,t){if(e){if(e[Lt]!==Rt)try{oo(e,Lt,Rt)}catch{e[Lt]=Rt}if(bm(e,t,!0),Vr[t]){for(var n in me)if(e[n]!==me[n])try{oo(e,n,me[n])}catch{e[n]=me[n]}}}};for(var _t in Vr)Nr(ao[_t]&&ao[_t].prototype,_t);Nr(hm,"DOMTokenList");var xm=R,wm=function(){var e=xm(this),t="";return e.hasIndices&&(t+="d"),e.global&&(t+="g"),e.ignoreCase&&(t+="i"),e.multiline&&(t+="m"),e.dotAll&&(t+="s"),e.unicode&&(t+="u"),e.unicodeSets&&(t+="v"),e.sticky&&(t+="y"),t},_n=$,$m=A,zn=$m.RegExp,jn=_n(function(){var e=zn("a","y");return e.lastIndex=2,e.exec("abcd")!==null}),km=jn||_n(function(){return!zn("a","y").sticky}),Sm=jn||_n(function(){var e=zn("^r","gy");return e.lastIndex=2,e.exec("str")!==null}),Im={BROKEN_CARET:Sm,MISSED_STICKY:km,UNSUPPORTED_Y:jn},Am=$,Em=A,Pm=Em.RegExp,Dm=Am(function(){var e=Pm(".","s");return!(e.dotAll&&e.test(`
`)&&e.flags==="s")}),qm=$,Mm=A,Om=Mm.RegExp,Cm=qm(function(){var e=Om("(?<a>b)","g");return e.exec("b").groups.a!=="b"||"b".replace(e,"$<a>c")!=="bc"}),oe=z,ct=S,Lm=st,Rm=wm,_m=Im,zm=Tn,jm=lt,Bm=we.get,Hm=Dm,Fm=Cm,Vm=zm("native-string-replace",String.prototype.replace),Ne=RegExp.prototype.exec,an=Ne,Nm=ct("".charAt),Wm=ct("".indexOf),Um=ct("".replace),zt=ct("".slice),on=function(){var e=/a/,t=/b*/g;return oe(Ne,e,"a"),oe(Ne,t,"a"),e.lastIndex!==0||t.lastIndex!==0}(),Wr=_m.BROKEN_CARET,rn=/()??/.exec("")[1]!==void 0,Gm=on||rn||Wr||Hm||Fm;Gm&&(an=function(t){var n=this,a=Bm(n),o=Lm(t),l=a.raw,r,c,i,u,s,p,d;if(l)return l.lastIndex=n.lastIndex,r=oe(an,l,o),n.lastIndex=l.lastIndex,r;var g=a.groups,v=Wr&&n.sticky,y=oe(Rm,n),T=n.source,m=0,f=o;if(v&&(y=Um(y,"y",""),Wm(y,"g")===-1&&(y+="g"),f=zt(o,n.lastIndex),n.lastIndex>0&&(!n.multiline||n.multiline&&Nm(o,n.lastIndex-1)!==`
`)&&(T="(?: "+T+")",f=" "+f,m++),c=new RegExp("^(?:"+T+")",y)),rn&&(c=new RegExp("^"+T+"$(?!\\s)",y)),on&&(i=n.lastIndex),u=oe(Ne,v?c:n,f),v?u?(u.input=zt(u.input,m),u[0]=zt(u[0],m),u.index=n.lastIndex,n.lastIndex+=u[0].length):n.lastIndex=0:on&&u&&(n.lastIndex=n.global?u.index+u[0].length:i),rn&&u&&u.length>1&&oe(Vm,u[0],c,function(){for(s=1;s<arguments.length-2;s++)arguments[s]===void 0&&(u[s]=void 0)}),u&&g)for(u.groups=p=jm(null),s=0;s<g.length;s++)d=g[s],p[d[0]]=u[d[1]];return u});var Bn=an,Km=ke,ro=Bn;Km({target:"RegExp",proto:!0,forced:/./.exec!==ro},{exec:ro});var Ym=Ye,Ur=Function.prototype,lo=Ur.apply,io=Ur.call,Jm=typeof Reflect=="object"&&Reflect.apply||(Ym?io.bind(lo):function(){return io.apply(lo,arguments)}),so=qr,co=J,Xm=Bn,uo=$,Gr=I,Zm=xe,Qm=Gr("species"),jt=RegExp.prototype,ef=function(e,t,n,a){var o=Gr(e),l=!uo(function(){var u={};return u[o]=function(){return 7},""[e](u)!==7}),r=l&&!uo(function(){var u=!1,s=/a/;return e==="split"&&(s={},s.constructor={},s.constructor[Qm]=function(){return s},s.flags="",s[o]=/./[o]),s.exec=function(){return u=!0,null},s[o](""),!u});if(!l||!r||n){var c=so(/./[o]),i=t(o,""[e],function(u,s,p,d,g){var v=so(u),y=s.exec;return y===Xm||y===jt.exec?l&&!g?{done:!0,value:c(s,p,d)}:{done:!0,value:v(p,s,d)}:{done:!1}});co(String.prototype,e,i[0]),co(jt,o,i[1])}a&&Zm(jt[o],"sham",!0)},tf=Br.charAt,nf=function(e,t,n){return t+(n?tf(e,t).length:1)},Hn=S,af=et,of=Math.floor,Bt=Hn("".charAt),rf=Hn("".replace),Ht=Hn("".slice),lf=/\$([$&'`]|\d{1,2}|<[^>]*>)/g,sf=/\$([$&'`]|\d{1,2})/g,cf=function(e,t,n,a,o,l){var r=n+e.length,c=a.length,i=sf;return o!==void 0&&(o=af(o),i=lf),rf(l,i,function(u,s){var p;switch(Bt(s,0)){case"$":return"$";case"&":return e;case"`":return Ht(t,0,n);case"'":return Ht(t,r);case"<":p=o[Ht(s,1,-1)];break;default:var d=+s;if(d===0)return u;if(d>c){var g=of(d/10);return g===0?u:g<=c?a[g-1]===void 0?Bt(s,1):a[g-1]+Bt(s,1):u}p=a[d-1]}return p===void 0?"":p})},po=z,uf=R,pf=k,df=Y,gf=Bn,mf=TypeError,ff=function(e,t){var n=e.exec;if(pf(n)){var a=po(n,e,t);return a!==null&&uf(a),a}if(df(e)==="RegExp")return po(gf,e,t);throw new mf("RegExp#exec called on incompatible receiver")},vf=Jm,go=z,ut=S,yf=ef,hf=$,bf=R,Tf=k,xf=re,wf=at,$f=nr,Q=st,kf=Xe,Sf=nf,If=Qe,Af=cf,Ef=ff,Pf=I,ln=Pf("replace"),Df=Math.max,qf=Math.min,Mf=ut([].concat),Ft=ut([].push),mo=ut("".indexOf),fo=ut("".slice),Of=function(e){return e===void 0?e:String(e)},Cf=function(){return"a".replace(/./,"$0")==="$0"}(),vo=function(){return/./[ln]?/./[ln]("a","$0")==="":!1}(),Lf=!hf(function(){var e=/./;return e.exec=function(){var t=[];return t.groups={a:"7"},t},"".replace(e,"$<a>")!=="7"});yf("replace",function(e,t,n){var a=vo?"$":"$0";return[function(l,r){var c=kf(this),i=xf(l)?void 0:If(l,ln);return i?go(i,l,c,r):go(t,Q(c),l,r)},function(o,l){var r=bf(this),c=Q(o);if(typeof l=="string"&&mo(l,a)===-1&&mo(l,"$<")===-1){var i=n(t,r,c,l);if(i.done)return i.value}var u=Tf(l);u||(l=Q(l));var s=r.global,p;s&&(p=r.unicode,r.lastIndex=0);for(var d=[],g;g=Ef(r,c),!(g===null||(Ft(d,g),!s));){var v=Q(g[0]);v===""&&(r.lastIndex=Sf(c,$f(r.lastIndex),p))}for(var y="",T=0,m=0;m<d.length;m++){g=d[m];for(var f=Q(g[0]),h=Df(qf(wf(g.index),c.length),0),b=[],x,X=1;X<g.length;X++)Ft(b,Of(g[X]));var ie=g.groups;if(u){var se=Mf([f],b,h,c);ie!==void 0&&Ft(se,ie),x=Q(vf(l,void 0,se))}else x=Af(f,c,h,b,ie,l);h>=T&&(y+=fo(c,T,h)+x,T=h+f.length)}return y+fo(c,T)}]},!Lf||!Cf||vo);var fe;typeof window<"u"?fe=window:typeof W<"u"?fe=W:typeof self<"u"?fe=self:fe={};var Rf=fe;const Kr=bl(Rf);var _f=Kr.LOGLEVEL,D=Kr.console,N={trace:1,debug:2,info:3,warn:4,error:5,silent:10},zf=_f,ee=N[zf]||N.info,ye={trace:function(t){for(var n=arguments.length,a=new Array(n>1?n-1:0),o=1;o<n;o++)a[o-1]=arguments[o];return ee<=N.trace&&D.trace.apply(D,[t].concat(a))},debug:function(t){for(var n=arguments.length,a=new Array(n>1?n-1:0),o=1;o<n;o++)a[o-1]=arguments[o];return ee<=N.debug&&D.debug.apply(D,[t].concat(a))},info:function(t){for(var n=arguments.length,a=new Array(n>1?n-1:0),o=1;o<n;o++)a[o-1]=arguments[o];return ee<=N.info&&D.info.apply(D,[t].concat(a))},warn:function(t){for(var n=arguments.length,a=new Array(n>1?n-1:0),o=1;o<n;o++)a[o-1]=arguments[o];return ee<=N.warn&&D.warn.apply(D,[t].concat(a))},error:function(t){for(var n=arguments.length,a=new Array(n>1?n-1:0),o=1;o<n;o++)a[o-1]=arguments[o];return ee<=N.error&&D.error.apply(D,[t].concat(a))},log:function(t){for(var n=arguments.length,a=new Array(n>1?n-1:0),o=1;o<n;o++)a[o-1]=arguments[o];return ee<N.silent&&D.log.apply(D,[t].concat(a))}},sn=new Set,P=function(t){return function(n){if(!sn.has(n)){sn.add(n);for(var a=arguments.length,o=new Array(a>1?a-1:0),l=1;l<a;l++)o[l-1]=arguments[l];return ye[t].apply(ye,[n].concat(o))}}};P.clear=function(){return sn.clear()};P.trace=P("trace");P.debug=P("debug");P.info=P("info");P.warn=P("warn");P.error=P("error");P.log=P("log");var O=function(t){return function(){for(var n=[],a=arguments.length,o=new Array(a),l=0;l<a;l++)o[l]=arguments[l];if(o.length){var r=/<span\s+style=(['"])([^'"]*)\1\s*>/gi,c=/<\/span>/gi,i;for(n.push(o[0].replace(r,"%c").replace(c,"%c"));i=r.exec(o[0]);)n.push(i[2]),n.push("");for(var u=1;u<o.length;u++)n.push(o[u])}ye[t].apply(ye,n)}};O.trace=O("trace");O.debug=O("debug");O.info=O("info");O.warn=O("warn");O.error=O("error");const jf=Object.freeze(Object.defineProperty({__proto__:null,logger:ye,once:P,pretty:O},Symbol.toStringTag,{value:"Module"})),Bf=Tl(jf);(function(e){var t=W&&W.__assign||function(){return t=Object.assign||function(m){for(var f,h=1,b=arguments.length;h<b;h++){f=arguments[h];for(var x in f)Object.prototype.hasOwnProperty.call(f,x)&&(m[x]=f[x])}return m},t.apply(this,arguments)};Object.defineProperty(e,"__esModule",{value:!0}),e.extractComponentDescription=e.extractArgTypes=e.extractArgTypesFactory=e.extractArgTypesFromElements=e.getStencilDocJson=e.setStencilDocJson=void 0;var n=Bf,a=function(m){if(!m)return!1;if(typeof m=="string")return!0;throw new Error('Provided component needs to be a string. e.g. component: "my-element"')},o=function(m){if(!m)return!1;if(m.components&&Array.isArray(m.components))return!0;throw new Error(`You need to setup valid meta data in your preview.js via setStencilDocJson().
    The meta data can be generated with the stencil output target 'docs-json'.`)},l=function(m,f){if(!a(m)||!o(f))return null;var h=f.components.find(function(b){return b.tag.toUpperCase()===m.toUpperCase()});return h||n.logger.warn("Component not found in stencil doc json: ".concat(m)),h},r=function(m){return m.values.filter(function(f){return["string","number"].includes(f.type)}).map(function(f){return f.value})},c=function(m){var f,h=null;switch(m.type){case"string":f={type:"text"};break;case"number":f={type:"number"};break;case"boolean":f={type:"boolean"};break;case"function":case"void":f=null;break;default:h=r(m),h.length===0?f={type:"object"}:h.length<5?f={type:"radio"}:f={type:"select"}}return{control:f,options:h}},i=function(m,f){var h=f.dashCase;return m&&m.reduce(function(b,x){var X=c(x),ie=X.control,se=X.options,Yn=h===!0&&x.attr||x.name;return b[Yn]={name:x.attr||x.name,description:x.docs,type:{required:x.required},control:ie,table:{category:"props",type:{summary:x.type},defaultValue:{summary:x.default}}},se!==null&&(b[Yn].options=se),b},{})},u=function(m){return m&&m.reduce(function(f,h){return f["event-".concat(h.event)]={name:h.event,description:h.docs,type:{name:"void"},control:null,table:{category:"events",type:{summary:h.detail}}},f},{})},s=function(m){return m&&m.reduce(function(f,h){return f["method-".concat(h.name)]={name:h.name,description:h.docs,type:{name:"void"},control:null,table:{category:"methods",type:{summary:h.signature}}},f},{})},p=function(m,f){return m&&m.reduce(function(h,b){var x={name:"void"};return h["".concat(f.replace(/\s/g,"-").toLowerCase(),"-").concat(b.name)]={name:b.name,required:!1,description:b.docs,control:null,type:x,table:{category:f,type:x}},h},{})},d=function(m){window.__STORYBOOK_STENCIL_DOC_JSON__=m};e.setStencilDocJson=d;var g=function(){return window.__STORYBOOK_STENCIL_DOC_JSON__};e.getStencilDocJson=g;var v=function(m,f,h){var b=l(m,f);return b&&t(t(t(t(t(t({},i(b.props,h)),u(b.events)),s(b.methods)),p(b.slots,"slots")),p(b.styles,"css custom properties")),p(b.parts,"css shadow parts"))};e.extractArgTypesFromElements=v;var y=function(m){return m===void 0&&(m={}),function(f){return(0,e.extractArgTypesFromElements)(f,(0,e.getStencilDocJson)(),t({dashCase:!1},m))}};e.extractArgTypesFactory=y,e.extractArgTypes=(0,e.extractArgTypesFactory)();var T=function(m){var f=l(m,(0,e.getStencilDocJson)());return f&&(f.readme||f.docs)};e.extractComponentDescription=T})(Be);const{addons:Hf}=__STORYBOOK_MODULE_PREVIEW_API__,{global:yo}=__STORYBOOK_MODULE_GLOBAL__,{ImplicitActionsDuringRendering:Ff}=__STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__;var Vf="actions",Nf="storybook/actions",Wf=`${Nf}/action-event`,cn={depth:10,clearOnStoryChange:!0,limit:50},Yr=(e,t)=>{let n=Object.getPrototypeOf(e);return!n||t(n)?n:Yr(n,t)},Uf=e=>!!(typeof e=="object"&&e&&Yr(e,t=>/^Synthetic(?:Base)?Event$/.test(t.constructor.name))&&typeof e.persist=="function"),Gf=e=>{if(Uf(e)){let t=Object.create(e.constructor.prototype,Object.getOwnPropertyDescriptors(e));t.persist();let n=Object.getOwnPropertyDescriptor(t,"view"),a=n==null?void 0:n.value;return typeof a=="object"&&(a==null?void 0:a.constructor.name)==="Window"&&Object.defineProperty(t,"view",{...n,value:Object.create(a.constructor.prototype)}),t}return e},Kf=()=>typeof crypto=="object"&&typeof crypto.getRandomValues=="function"?xl():Date.now().toString(36)+Math.random().toString(36).substring(2);function Yf(e,t={}){let n={...cn,...t},a=function(...o){var p,d;if(t.implicit){let g=(p="__STORYBOOK_PREVIEW__"in yo?yo.__STORYBOOK_PREVIEW__:void 0)==null?void 0:p.storyRenders.find(v=>v.phase==="playing"||v.phase==="rendering");if(g){let v=!((d=window==null?void 0:window.FEATURES)!=null&&d.disallowImplicitActionsInRenderV8),y=new Ff({phase:g.phase,name:e,deprecated:v});if(v)console.warn(y);else throw y}}let l=Hf.getChannel(),r=Kf(),c=5,i=o.map(Gf),u=o.length>1?i:i[0],s={id:r,count:0,data:{name:e,args:u},options:{...n,maxDepth:c+(n.depth||3),allowFunction:n.allowFunction||!1}};l.emit(Wf,s)};return a.isAction=!0,a.implicit=t.implicit,a}var Jf=(...e)=>{let t=cn,n=e;n.length===1&&Array.isArray(n[0])&&([n]=n),n.length!==1&&typeof n[n.length-1]!="string"&&(t={...cn,...n.pop()});let a=n[0];(n.length!==1||typeof a=="string")&&(a={},n.forEach(l=>{a[l]=l}));let o={};return Object.keys(a).forEach(l=>{o[l]=Yf(a[l],t)}),o};const{global:Xf}=__STORYBOOK_MODULE_GLOBAL__,{makeDecorator:Zf,useEffect:Qf}=__STORYBOOK_MODULE_PREVIEW_API__;var{document:ho,Element:bo}=Xf,ev=/^(\S+)\s*(.*)$/,tv=bo!=null&&!bo.prototype.matches,nv=tv?"msMatchesSelector":"matches",Jr=(e,t)=>{if(e[nv](t))return!0;let n=e.parentElement;return n?Jr(n,t):!1},av=(e,...t)=>{let n=e(...t);return Object.entries(n).map(([a,o])=>{let[l,r,c]=a.match(ev)||[];return{eventName:r,handler:i=>{(!c||Jr(i.target,c))&&o(i)}}})},ov=(e,...t)=>{let n=ho&&ho.getElementById("storybook-root");Qf(()=>{if(n!=null){let a=av(e,...t);return a.forEach(({eventName:o,handler:l})=>n.addEventListener(o,l)),()=>a.forEach(({eventName:o,handler:l})=>n.removeEventListener(o,l))}},[n,e,t])},rv=Zf({name:"withActions",parameterName:Vf,skipIfNoParametersOrOptions:!0,wrapper:(e,t,{parameters:n})=>(n!=null&&n.handles&&ov(Jf,...n.handles),e(t))});const lv="2024-05-13T12:49:07",iv={name:"@stencil/core",version:"4.18.0",typescriptVersion:"5.4.5"},sv=[{filePath:"src/components/molecules/mg-action-more/mg-action-more.tsx",encapsulation:"shadow",tag:"mg-action-more",readme:`## Anatomy
...
use to match checkbox attributes`,path:"src/components/molecules/inputs/mg-input-checkbox/mg-input-checkbox.conf.ts"},"src/components/molecules/inputs/mg-input-checkbox/mg-input-checkbox.conf.ts::SectionKind":{declaration:`export enum SectionKind {
  ...
  status: Status;
}`,docstring:"",path:"src/components/molecules/mg-tabs/mg-tabs.conf.ts"}},uv={timestamp:lv,compiler:iv,components:sv,typeLibrary:cv},pv="mg-components",Xr={allRenderFn:!1,appendChildSlotFix:!1,asyncLoading:!0,asyncQueue:!1,attachStyles:!0,cloneNodeFix:!1,cmpDidLoad:!0,cmpDidRender:!0,cmpDidUnload:!1,cmpDidUpdate:!0,cmpShouldUpdate:!0,cmpWillLoad:!0,cmpWillRender:!1,cmpWillUpdate:!0,connectedCallback:!1,constructableCSS:!0,cssAnnotations:!0,devTools:!1,disconnectedCallback:!0,element:!1,event:!0,experimentalScopedSlotChanges:!1,experimentalSlotFixes:!1,formAssociated:!1,hasRenderFn:!0,hostListener:!0,hostListenerTarget:!0,hostListenerTargetBody:!1,hostListenerTargetDocument:!1,hostListenerTargetParent:!1,hostListenerTargetWindow:!0,hotModuleReplacement:!1,hydrateClientSide:!1,hydrateServerSide:!1,hydratedAttribute:!1,hydratedClass:!0,initializeNextTick:!1,invisiblePrehydration:!0,isDebug:!1,isDev:!1,isTesting:!1,lazyLoad:!0,lifecycle:!0,lifecycleDOMEvents:!1,member:!0,method:!0,mode:!1,observeAttribute:!0,profile:!1,prop:!0,propBoolean:!0,propMutable:!0,propNumber:!0,propString:!0,reflect:!0,scoped:!0,scopedSlotTextContentFix:!1,scriptDataOpts:!1,shadowDelegatesFocus:!1,shadowDom:!0,slot:!0,slotChildNodesFix:!1,slotRelocation:!0,state:!0,style:!0,svg:!1,taskQueue:!0,transformTagName:!1,updatable:!0,vdomAttribute:!0,vdomClass:!0,vdomFunctional:!0,vdomKey:!0,vdomListener:!0,vdomPropOrAttr:!0,vdomRef:!0,vdomRender:!0,vdomStyle:!0,vdomText:!0,vdomXlink:!0,watchCallback:!0};var dv=Object.defineProperty,gv=(e,t)=>{for(var n in t)dv(e,n,{get:t[n],enumerable:!0})},To={},mv=e=>e!=null,Fn=e=>(e=typeof e,e==="object"||e==="function");function Zr(e){var t,n,a;return(a=(n=(t=e.head)==null?void 0:t.querySelector('meta[name="csp-nonce"]'))==null?void 0:n.getAttribute("content"))!=null?a:void 0}var fv={};gv(fv,{err:()=>Qr,map:()=>vv,ok:()=>un,unwrap:()=>yv,unwrapErr:()=>hv});var un=e=>({isOk:!0,isErr:!1,value:e}),Qr=e=>({isOk:!1,isErr:!0,value:e});function vv(e,t){if(e.isOk){const n=t(e.value);return n instanceof Promise?n.then(a=>un(a)):un(n)}if(e.isErr){const n=e.value;return Qr(n)}throw"should never get here"}var yv=e=>{if(e.isOk)return e.value;throw e.value},hv=e=>{if(e.isErr)return e.value;throw e.value},V=(e,t="")=>()=>{},bv=(e,t)=>()=>{},Tv="{visibility:hidden}.hydrated{visibility:inherit}",el="slot-fb{display:contents}slot-fb[hidden]{display:none}",xo="http://www.w3.org/1999/xlink",tl=(e,t,...n)=>{let a=null,o=null,l=null,r=!1,c=!1;const i=[],u=p=>{for(let d=0;d<p.length;d++)a=p[d],Array.isArray(a)?u(a):a!=null&&typeof a!="boolean"&&((r=typeof e!="function"&&!Fn(a))&&(a=String(a)),r&&c?i[i.length-1].$text$+=a:i.push(r?We(null,a):a),c=r)};if(u(n),t){t.key&&(o=t.key),t.name&&(l=t.name);{const p=t.className||t.class;p&&(t.class=typeof p!="object"?p:Object.keys(p).filter(d=>p[d]).join(" "))}}if(typeof e=="function")return e(t===null?{}:t,i,$v);const s=We(e,null);return s.$attrs$=t,i.length>0&&(s.$children$=i),s.$key$=o,s.$name$=l,s},We=(e,t)=>{const n={$flags$:0,$tag$:e,$text$:t,$elm$:null,$children$:null};return n.$attrs$=null,n.$key$=null,n.$name$=null,n},xv={},wv=e=>e&&e.$tag$===xv,$v={forEach:(e,t)=>e.map(wo).forEach(t),map:(e,t)=>e.map(wo).map(t).map(kv)},wo=e=>({vattrs:e.$attrs$,vchildren:e.$children$,vkey:e.$key$,vname:e.$name$,vtag:e.$tag$,vtext:e.$text$}),kv=e=>{if(typeof e.vtag=="function"){const n={...e.vattrs};return e.vkey&&(n.key=e.vkey),e.vname&&(n.name=e.vname),tl(e.vtag,n,...e.vchildren||[])}const t=We(e.vtag,e.vtext);return t.$attrs$=e.vattrs,t.$children$=e.vchildren,t.$key$=e.vkey,t.$name$=e.vname,t},Sv=(e,t)=>e!=null&&!Fn(e)?t&4?e==="false"?!1:e===""||!!e:t&2?parseFloat(e):t&1?String(e):e:e,Iv=e=>U(e).$hostElement$,gy=(e,t,n)=>{const a=Iv(e);return{emit:o=>nl(a,t,{bubbles:!!(n&4),composed:!!(n&2),cancelable:!!(n&1),detail:o})}},nl=(e,t,n)=>{const a=w.ce(t,n);return e.dispatchEvent(a),a},$o=new WeakMap,Av=(e,t,n)=>{let a=Ke.get(e);ty&&n?(a=a||new CSSStyleSheet,typeof a=="string"?a=t:a.replaceSync(t)):a=t,Ke.set(e,a)},Ev=(e,t,n)=>{var a;const o=al(t),l=Ke.get(o);if(e=e.nodeType===11?e:E,l)if(typeof l=="string"){e=e.head||e;let r=$o.get(e),c;if(r||$o.set(e,r=new Set),!r.has(o)){{c=E.createElement("style"),c.innerHTML=l;const i=(a=w.$nonce$)!=null?a:Zr(E);i!=null&&c.setAttribute("nonce",i),e.insertBefore(c,e.querySelector("link"))}t.$flags$&4&&(c.innerHTML+=el),r&&r.add(o)}}else e.adoptedStyleSheets.includes(l)||(e.adoptedStyleSheets=[...e.adoptedStyleSheets,l]);return o},Pv=e=>{const t=e.$cmpMeta$,n=e.$hostElement$,a=t.$flags$,o=V("attachStyles",t.$tagName$),l=Ev(n.shadowRoot?n.shadowRoot:n.getRootNode(),t);a&10&&(n["s-sc"]=l,n.classList.add(l+"-h"),a&2&&n.classList.add(l+"-s")),o()},al=(e,t)=>"sc-"+e.$tagName$,ko=(e,t,n,a,o,l)=>{if(n!==a){let r=Po(e,t),c=t.toLowerCase();if(t==="class"){const i=e.classList,u=So(n),s=So(a);i.remove(...u.filter(p=>p&&!s.includes(p))),i.add(...s.filter(p=>p&&!u.includes(p)))}else if(t==="style"){for(const i in n)(!a||a[i]==null)&&(i.includes("-")?e.style.removeProperty(i):e.style[i]="");for(const i in a)(!n||a[i]!==n[i])&&(i.includes("-")?e.style.setProperty(i,a[i]):e.style[i]=a[i])}else if(t!=="key")if(t==="ref")a&&a(e);else if(!r&&t[0]==="o"&&t[1]==="n"){if(t[2]==="-"?t=t.slice(3):Po(Ie,c)?t=c.slice(2):t=c[2]+t.slice(3),n||a){const i=t.endsWith(ol);t=t.replace(qv,""),n&&w.rel(e,t,n,i),a&&w.ael(e,t,a,i)}}else{const i=Fn(a);if((r||i&&a!==null)&&!o)try{if(e.tagName.includes("-"))e[t]=a;else{const s=a??"";t==="list"?r=!1:(n==null||e[t]!=s)&&(e[t]=s)}}catch{}let u=!1;c!==(c=c.replace(/^xlink\:?/,""))&&(t=c,u=!0),a==null||a===!1?(a!==!1||e.getAttribute(t)==="")&&(u?e.removeAttributeNS(xo,t):e.removeAttribute(t)):(!r||l&4||o)&&!i&&(a=a===!0?"":a,u?e.setAttributeNS(xo,t,a):e.setAttribute(t,a))}}},Dv=/\s/,So=e=>e?e.split(Dv):[],ol="Capture",qv=new RegExp(ol+"$"),rl=(e,t,n)=>{const a=t.$elm$.nodeType===11&&t.$elm$.host?t.$elm$.host:t.$elm$,o=e&&e.$attrs$||To,l=t.$attrs$||To;for(const r of Io(Object.keys(o)))r in l||ko(a,r,o[r],void 0,n,t.$flags$);for(const r of Io(Object.keys(l)))ko(a,r,o[r],l[r],n,t.$flags$)};function Io(e){return e.includes("ref")?[...e.filter(t=>t!=="ref"),"ref"]:e}var te,pn,he,Vn=!1,Ue=!1,Nn=!1,ll=!1,Ge=(e,t,n,a)=>{var o,l,r,c;const i=t.$children$[n];let u=0,s,p,d;if(Vn||(Nn=!0,i.$tag$==="slot"&&(te&&a.classList.add(te+"-s"),i.$flags$|=i.$children$?2:1)),i.$text$!==null)s=i.$elm$=E.createTextNode(i.$text$);else if(i.$flags$&1)s=i.$elm$=E.createTextNode("");else{s=i.$elm$=E.createElement(i.$flags$&2?"slot-fb":i.$tag$),rl(null,i,ll),mv(te)&&s["s-si"]!==te&&s.classList.add(s["s-si"]=te);{const g=((o=t.$elm$)==null?void 0:o["s-rsc"])||((l=t.$elm$)==null?void 0:l["s-si"])||((r=t.$elm$)==null?void 0:r["s-sc"]);g&&(s["s-rsc"]=g,!s.classList.contains(g)&&s.classList.add(g))}if(i.$children$)for(u=0;u<i.$children$.length;++u)p=Ge(e,i,u,s),p&&s.appendChild(p)}return s["s-hn"]=he,i.$flags$&3&&(s["s-sr"]=!0,s["s-cr"]=pn,s["s-sn"]=i.$name$||"",s["s-rf"]=(c=i.$attrs$)==null?void 0:c.ref,d=e&&e.$children$&&e.$children$[n],d&&d.$tag$===i.$tag$&&e.$elm$&&be(e.$elm$,!1)),s},be=(e,t)=>{w.$flags$|=1;const n=Array.from(e.childNodes);if(e["s-sr"]&&Xr.experimentalSlotFixes){let a=e;for(;a=a.nextSibling;)a&&a["s-sn"]===e["s-sn"]&&a["s-sh"]===he&&n.push(a)}for(let a=n.length-1;a>=0;a--){const o=n[a];o["s-hn"]!==he&&o["s-ol"]&&(cl(o).insertBefore(o,Wn(o)),o["s-ol"].remove(),o["s-ol"]=void 0,o["s-sh"]=void 0,Nn=!0),t&&be(o,t)}w.$flags$&=-2},il=(e,t,n,a,o,l)=>{let r=e["s-cr"]&&e["s-cr"].parentNode||e,c;for(r.shadowRoot&&r.tagName===he&&(r=r.shadowRoot);o<=l;++o)a[o]&&(c=Ge(null,n,o,e),c&&(a[o].$elm$=c,r.insertBefore(c,Wn(t))))},sl=(e,t,n)=>{for(let a=t;a<=n;++a){const o=e[a];if(o){const l=o.$elm$;dl(o),l&&(Ue=!0,l["s-ol"]?l["s-ol"].remove():be(l,!0),l.remove())}}},Mv=(e,t,n,a,o=!1)=>{let l=0,r=0,c=0,i=0,u=t.length-1,s=t[0],p=t[u],d=a.length-1,g=a[0],v=a[d],y,T;for(;l<=u&&r<=d;)if(s==null)s=t[++l];else if(p==null)p=t[--u];else if(g==null)g=a[++r];else if(v==null)v=a[--d];else if(Ce(s,g,o))ne(s,g,o),s=t[++l],g=a[++r];else if(Ce(p,v,o))ne(p,v,o),p=t[--u],v=a[--d];else if(Ce(s,v,o))(s.$tag$==="slot"||v.$tag$==="slot")&&be(s.$elm$.parentNode,!1),ne(s,v,o),e.insertBefore(s.$elm$,p.$elm$.nextSibling),s=t[++l],v=a[--d];else if(Ce(p,g,o))(s.$tag$==="slot"||v.$tag$==="slot")&&be(p.$elm$.parentNode,!1),ne(p,g,o),e.insertBefore(p.$elm$,s.$elm$),p=t[--u],g=a[++r];else{for(c=-1,i=l;i<=u;++i)if(t[i]&&t[i].$key$!==null&&t[i].$key$===g.$key$){c=i;break}c>=0?(T=t[c],T.$tag$!==g.$tag$?y=Ge(t&&t[r],n,c,e):(ne(T,g,o),t[c]=void 0,y=T.$elm$),g=a[++r]):(y=Ge(t&&t[r],n,r,e),g=a[++r]),y&&cl(s.$elm$).insertBefore(y,Wn(s.$elm$))}l>u?il(e,a[d+1]==null?null:a[d+1].$elm$,n,a,r,d):r>d&&sl(t,l,u)},Ce=(e,t,n=!1)=>e.$tag$===t.$tag$?e.$tag$==="slot"?e.$name$===t.$name$:n?!0:e.$key$===t.$key$:!1,Wn=e=>e&&e["s-ol"]||e,cl=e=>(e["s-ol"]?e["s-ol"]:e).parentNode,ne=(e,t,n=!1)=>{const a=t.$elm$=e.$elm$,o=e.$children$,l=t.$children$,r=t.$tag$,c=t.$text$;let i;c===null?(r==="slot"&&!Vn||rl(e,t,ll),o!==null&&l!==null?Mv(a,o,t,l,n):l!==null?(e.$text$!==null&&(a.textContent=""),il(a,null,t,l,0,l.length-1)):o!==null&&sl(o,0,o.length-1)):(i=a["s-cr"])?i.parentNode.textContent=c:e.$text$!==c&&(a.data=c)},ul=e=>{const t=e.childNodes;for(const n of t)if(n.nodeType===1){if(n["s-sr"]){const a=n["s-sn"];n.hidden=!1;for(const o of t)if(o!==n){if(o["s-hn"]!==n["s-hn"]||a!==""){if(o.nodeType===1&&(a===o.getAttribute("slot")||a===o["s-sn"])||o.nodeType===3&&a===o["s-sn"]){n.hidden=!0;break}}else if(o.nodeType===1||o.nodeType===3&&o.textContent.trim()!==""){n.hidden=!0;break}}}ul(n)}},B=[],pl=e=>{let t,n,a;for(const o of e.childNodes){if(o["s-sr"]&&(t=o["s-cr"])&&t.parentNode){n=t.parentNode.childNodes;const l=o["s-sn"];for(a=n.length-1;a>=0;a--)if(t=n[a],!t["s-cn"]&&!t["s-nr"]&&t["s-hn"]!==o["s-hn"]&&!Xr.experimentalSlotFixes)if(Ao(t,l)){let r=B.find(c=>c.$nodeToRelocate$===t);Ue=!0,t["s-sn"]=t["s-sn"]||l,r?(r.$nodeToRelocate$["s-sh"]=o["s-hn"],r.$slotRefNode$=o):(t["s-sh"]=o["s-hn"],B.push({$slotRefNode$:o,$nodeToRelocate$:t})),t["s-sr"]&&B.map(c=>{Ao(c.$nodeToRelocate$,t["s-sn"])&&(r=B.find(i=>i.$nodeToRelocate$===t),r&&!c.$slotRefNode$&&(c.$slotRefNode$=r.$slotRefNode$))})}else B.some(r=>r.$nodeToRelocate$===t)||B.push({$nodeToRelocate$:t})}o.nodeType===1&&pl(o)}},Ao=(e,t)=>e.nodeType===1?e.getAttribute("slot")===null&&t===""||e.getAttribute("slot")===t:e["s-sn"]===t?!0:t==="",dl=e=>{e.$attrs$&&e.$attrs$.ref&&e.$attrs$.ref(null),e.$children$&&e.$children$.map(dl)},Ov=(e,t,n=!1)=>{var a,o,l,r;const c=e.$hostElement$,i=e.$cmpMeta$,u=e.$vnode$||We(null,null),s=wv(t)?t:tl(null,null,t);if(he=c.tagName,i.$attrsToReflect$&&(s.$attrs$=s.$attrs$||{},i.$attrsToReflect$.map(([p,d])=>s.$attrs$[d]=c[p])),n&&s.$attrs$)for(const p of Object.keys(s.$attrs$))c.hasAttribute(p)&&!["key","ref","style","class"].includes(p)&&(s.$attrs$[p]=c[p]);s.$tag$=null,s.$flags$|=4,e.$vnode$=s,s.$elm$=u.$elm$=c.shadowRoot||c,te=c["s-sc"],Vn=(i.$flags$&1)!==0,pn=c["s-cr"],Ue=!1,ne(u,s,n);{if(w.$flags$|=1,Nn){pl(s.$elm$);for(const p of B){const d=p.$nodeToRelocate$;if(!d["s-ol"]){const g=E.createTextNode("");g["s-nr"]=d,d.parentNode.insertBefore(d["s-ol"]=g,d)}}for(const p of B){const d=p.$nodeToRelocate$,g=p.$slotRefNode$;if(g){const v=g.parentNode;let y=g.nextSibling;{let T=(a=d["s-ol"])==null?void 0:a.previousSibling;for(;T;){let m=(o=T["s-nr"])!=null?o:null;if(m&&m["s-sn"]===d["s-sn"]&&v===m.parentNode){for(m=m.nextSibling;m===d||m!=null&&m["s-sr"];)m=m==null?void 0:m.nextSibling;if(!m||!m["s-nr"]){y=m;break}}T=T.previousSibling}}(!y&&v!==d.parentNode||d.nextSibling!==y)&&d!==y&&(!d["s-hn"]&&d["s-ol"]&&(d["s-hn"]=d["s-ol"].parentNode.nodeName),v.insertBefore(d,y),d.nodeType===1&&(d.hidden=(l=d["s-ih"])!=null?l:!1)),d&&typeof g["s-rf"]=="function"&&g["s-rf"](d)}else d.nodeType===1&&(n&&(d["s-ih"]=(r=d.hidden)!=null?r:!1),d.hidden=!0)}}Ue&&ul(s.$elm$),w.$flags$&=-2,B.length=0}pn=void 0},gl=(e,t)=>{t&&!e.$onRenderResolve$&&t["s-p"]&&t["s-p"].push(new Promise(n=>e.$onRenderResolve$=n))},Un=(e,t)=>{if(e.$flags$|=16,e.$flags$&4){e.$flags$|=512;return}return gl(e,e.$ancestorComponent$),ay(()=>Cv(e,t))},Cv=(e,t)=>{const n=V("scheduleUpdate",e.$cmpMeta$.$tagName$),a=e.$lazyInstance$;let o;return t?(e.$flags$|=256,e.$queuedListeners$&&(e.$queuedListeners$.map(([l,r])=>G(a,l,r)),e.$queuedListeners$=void 0),o=G(a,"componentWillLoad")):o=G(a,"componentWillUpdate"),n(),Lv(o,()=>_v(e,a,t))},Lv=(e,t)=>Rv(e)?e.then(t):t(),Rv=e=>e instanceof Promise||e&&e.then&&typeof e.then=="function",_v=async(e,t,n)=>{var a;const o=e.$hostElement$,l=V("update",e.$cmpMeta$.$tagName$),r=o["s-rc"];n&&Pv(e);const c=V("render",e.$cmpMeta$.$tagName$);zv(e,t,o,n),r&&(r.map(i=>i()),o["s-rc"]=void 0),c(),l();{const i=(a=o["s-p"])!=null?a:[],u=()=>jv(e);i.length===0?u():(Promise.all(i).then(u),e.$flags$|=4,i.length=0)}},zv=(e,t,n,a)=>{try{t=t.render&&t.render(),e.$flags$&=-17,e.$flags$|=2,Ov(e,t,a)}catch(o){H(o,e.$hostElement$)}return null},jv=e=>{const t=e.$cmpMeta$.$tagName$,n=e.$hostElement$,a=V("postUpdate",t),o=e.$lazyInstance$,l=e.$ancestorComponent$;G(o,"componentDidRender"),e.$flags$&64?(G(o,"componentDidUpdate"),a()):(e.$flags$|=64,fl(n),G(o,"componentDidLoad"),a(),e.$onReadyResolve$(n),l||ml()),e.$onInstanceResolve$(n),e.$onRenderResolve$&&(e.$onRenderResolve$(),e.$onRenderResolve$=void 0),e.$flags$&512&&Kn(()=>Un(e,!1)),e.$flags$&=-517},ml=e=>{fl(E.documentElement),Kn(()=>nl(Ie,"appload",{detail:{namespace:pv}}))},G=(e,t,n)=>{if(e&&e[t])try{return e[t](n)}catch(a){H(a)}},fl=e=>e.classList.add("hydrated"),Bv=(e,t)=>U(e).$instanceValues$.get(t),Hv=(e,t,n,a)=>{const o=U(e),l=o.$hostElement$,r=o.$instanceValues$.get(t),c=o.$flags$,i=o.$lazyInstance$;n=Sv(n,a.$members$[t][0]);const u=Number.isNaN(r)&&Number.isNaN(n),s=n!==r&&!u;if((!(c&8)||r===void 0)&&s&&(o.$instanceValues$.set(t,n),i)){if(a.$watchers$&&c&128){const p=a.$watchers$[t];p&&p.map(d=>{try{i[d](n,r,t)}catch(g){H(g,l)}})}if((c&18)===2){if(i.componentShouldUpdate&&i.componentShouldUpdate(n,r,t)===!1)return;Un(o,!1)}}},vl=(e,t,n)=>{var a;const o=e.prototype;if(t.$members$){e.watchers&&(t.$watchers$=e.watchers);const l=Object.entries(t.$members$);if(l.map(([r,[c]])=>{c&31||n&2&&c&32?Object.defineProperty(o,r,{get(){return Bv(this,r)},set(i){Hv(this,r,i,t)},configurable:!0,enumerable:!0}):n&1&&c&64&&Object.defineProperty(o,r,{value(...i){var u;const s=U(this);return(u=s==null?void 0:s.$onInstancePromise$)==null?void 0:u.then(()=>{var p;return(p=s.$lazyInstance$)==null?void 0:p[r](...i)})}})}),n&1){const r=new Map;o.attributeChangedCallback=function(c,i,u){w.jmp(()=>{var s;const p=r.get(c);if(this.hasOwnProperty(p))u=this[p],delete this[p];else{if(o.hasOwnProperty(p)&&typeof this[p]=="number"&&this[p]==u)return;if(p==null){const d=U(this),g=d==null?void 0:d.$flags$;if(g&&!(g&8)&&g&128&&u!==i){const v=d.$lazyInstance$,y=(s=t.$watchers$)==null?void 0:s[c];y==null||y.forEach(T=>{v[T]!=null&&v[T].call(v,u,i,c)})}return}}this[p]=u===null&&typeof this[p]=="boolean"?!1:u})},e.observedAttributes=Array.from(new Set([...Object.keys((a=t.$watchers$)!=null?a:{}),...l.filter(([c,i])=>i[0]&15).map(([c,i])=>{var u;const s=i[1]||c;return r.set(s,c),i[0]&512&&((u=t.$attrsToReflect$)==null||u.push([c,s])),s})]))}}return e},Fv=async(e,t,n,a)=>{let o;if(!(t.$flags$&32)){if(t.$flags$|=32,n.$lazyBundleId$){if(o=Zv(n),o.then){const u=bv();o=await o,u()}o.isProxied||(n.$watchers$=o.watchers,vl(o,n,2),o.isProxied=!0);const i=V("createInstance",n.$tagName$);t.$flags$|=8;try{new o(t)}catch(u){H(u)}t.$flags$&=-9,t.$flags$|=128,i()}else o=e.constructor,customElements.whenDefined(n.$tagName$).then(()=>t.$flags$|=128);if(o.style){let i=o.style;const u=al(n);if(!Ke.has(u)){const s=V("registerStyles",n.$tagName$);Av(u,i,!!(n.$flags$&1)),s()}}}const l=t.$ancestorComponent$,r=()=>Un(t,!0);l&&l["s-rc"]?l["s-rc"].push(r):r()},Vv=e=>{},Nv=e=>{if(!(w.$flags$&1)){const t=U(e),n=t.$cmpMeta$,a=V("connectedCallback",n.$tagName$);if(t.$flags$&1)yl(e,t,n.$listeners$),t!=null&&t.$lazyInstance$||t!=null&&t.$onReadyPromise$&&t.$onReadyPromise$.then(()=>Vv());else{t.$flags$|=1,n.$flags$&12&&Wv(e);{let o=e;for(;o=o.parentNode||o.host;)if(o["s-p"]){gl(t,t.$ancestorComponent$=o);break}}n.$members$&&Object.entries(n.$members$).map(([o,[l]])=>{if(l&31&&e.hasOwnProperty(o)){const r=e[o];delete e[o],e[o]=r}}),Fv(e,t,n)}a()}},Wv=e=>{const t=e["s-cr"]=E.createComment("");t["s-cn"]=!0,e.insertBefore(t,e.firstChild)},Eo=e=>{G(e,"disconnectedCallback")},Uv=async e=>{if(!(w.$flags$&1)){const t=U(e);t.$rmListeners$&&(t.$rmListeners$.map(n=>n()),t.$rmListeners$=void 0),t!=null&&t.$lazyInstance$?Eo(t.$lazyInstance$):t!=null&&t.$onReadyPromise$&&t.$onReadyPromise$.then(()=>Eo(t.$lazyInstance$))}},Gv=(e,t={})=>{var n;const a=V(),o=[],l=t.exclude||[],r=Ie.customElements,c=E.head,i=c.querySelector("meta[charset]"),u=E.createElement("style"),s=[];let p,d=!0;Object.assign(w,t),w.$resourcesUrl$=new URL(t.resourcesUrl||"./",E.baseURI).href;let g=!1;if(e.map(v=>{v[1].map(y=>{var T;const m={$flags$:y[0],$tagName$:y[1],$members$:y[2],$listeners$:y[3]};m.$flags$&4&&(g=!0),m.$members$=y[2],m.$listeners$=y[3],m.$attrsToReflect$=[],m.$watchers$=(T=y[4])!=null?T:{};const f=m.$tagName$,h=class extends HTMLElement{constructor(b){super(b),b=this,Xv(b,m),m.$flags$&1&&b.attachShadow({mode:"open"})}connectedCallback(){p&&(clearTimeout(p),p=null),d?s.push(this):w.jmp(()=>Nv(this))}disconnectedCallback(){w.jmp(()=>Uv(this))}componentOnReady(){return U(this).$onReadyPromise$}};m.$lazyBundleId$=v[0],!l.includes(f)&&!r.get(f)&&(o.push(f),r.define(f,vl(h,m,1)))})}),o.length>0&&(g&&(u.textContent+=el),u.textContent+=o+Tv,u.innerHTML.length)){u.setAttribute("data-styles","");const v=(n=w.$nonce$)!=null?n:Zr(E);v!=null&&u.setAttribute("nonce",v),c.insertBefore(u,i?i.nextSibling:c.firstChild)}d=!1,s.length?s.map(v=>v.connectedCallback()):w.jmp(()=>p=setTimeout(ml,30)),a()},yl=(e,t,n,a)=>{n&&n.map(([o,l,r])=>{const c=Yv(e,o),i=Kv(t,r),u=Jv(o);w.ael(c,l,i,u),(t.$rmListeners$=t.$rmListeners$||[]).push(()=>w.rel(c,l,i,u))})},Kv=(e,t)=>n=>{try{e.$flags$&256?e.$lazyInstance$[t](n):(e.$queuedListeners$=e.$queuedListeners$||[]).push([t,n])}catch(a){H(a)}},Yv=(e,t)=>t&8?Ie:e,Jv=e=>Qv?{passive:(e&1)!==0,capture:(e&2)!==0}:(e&2)!==0,Gn=new WeakMap,U=e=>Gn.get(e),my=(e,t)=>Gn.set(t.$lazyInstance$=e,t),Xv=(e,t)=>{const n={$flags$:0,$hostElement$:e,$cmpMeta$:t,$instanceValues$:new Map};return n.$onInstancePromise$=new Promise(a=>n.$onInstanceResolve$=a),n.$onReadyPromise$=new Promise(a=>n.$onReadyResolve$=a),e["s-p"]=[],e["s-rc"]=[],yl(e,n,t.$listeners$),Gn.set(e,n)},Po=(e,t)=>t in e,H=(e,t)=>(0,console.error)(e,t),Vt=new Map,Zv=(e,t,n)=>{const a=e.$tagName$.replace(/-/g,"_"),o=e.$lazyBundleId$,l=Vt.get(o);if(l)return l[a];{const r=c=>(Vt.set(o,c),c[a]);switch(o){case"mg-action-more_36":return pt(()=>import("./mg-action-more_36.entry-D7TYZVBn.js"),__vite__mapDeps([0,1,2,3,4,5]),import.meta.url).then(r,H);case"mg-loader":return pt(()=>import("./mg-loader.entry-Se-AoS-9.js"),__vite__mapDeps([6,1,2,3,4,5]),import.meta.url).then(r,H)}}return pt(()=>import(`./${o}.entry.js`),[],import.meta.url).then(r=>(Vt.set(o,r),r[a]),H)},Ke=new Map,Ie=typeof window<"u"?window:{},E=Ie.document||{head:{}},w={$flags$:0,$resourcesUrl$:"",jmp:e=>e(),raf:e=>requestAnimationFrame(e),ael:(e,t,n,a)=>e.addEventListener(t,n,a),rel:(e,t,n,a)=>e.removeEventListener(t,n,a),ce:(e,t)=>new CustomEvent(e,t)},Qv=(()=>{let e=!1;try{E.addEventListener("e",null,Object.defineProperty({},"passive",{get(){e=!0}}))}catch{}return e})(),ey=e=>Promise.resolve(e),ty=(()=>{try{return new CSSStyleSheet,typeof new CSSStyleSheet().replaceSync=="function"}catch{}return!1})(),dn=!1,Do=[],hl=[],ny=(e,t)=>n=>{e.push(n),dn||(dn=!0,w.$flags$&4?Kn(gn):w.raf(gn))},qo=e=>{for(let t=0;t<e.length;t++)try{e[t](performance.now())}catch(n){H(n)}e.length=0},gn=()=>{qo(Do),qo(hl),(dn=Do.length>0)&&w.raf(gn)},Kn=e=>ey().then(e),ay=ny(hl);const oy=()=>{},ry=async(e,t)=>{if(!(typeof window>"u"))return await oy(),Gv(JSON.parse('[["mg-action-more_36",[[1,"mg-input-checkbox",{"value":[1040],"type":[1025],"identifier":[1],"name":[1],"label":[1],"labelOnTop":[4,"label-on-top"],"labelHide":[4,"label-hide"],"inputVerticalList":[4,"input-vertical-list"],"required":[4],"readonly":[4],"displaySelectedValues":[4,"display-selected-values"],"disabled":[4],"tooltip":[1],"tooltipPosition":[1,"tooltip-position"],"helpText":[1,"help-text"],"valid":[1028],"invalid":[1028],"classCollection":[32],"errorMessage":[32],"checkboxItems":[32],"displaySearchInput":[32],"searchValue":[32],"searchResults":[32],"selectValuesButtonKey":[32],"displayError":[64],"setError":[64]},null,{"value":["validateValue"],"type":["validateType"],"inputVerticalList":["watchInputVerticalList"],"readonly":["watchReadonly","handleValidityChange"],"displaySelectedValues":["watchDisplaySelectedValues"],"required":["handleValidityChange"],"disabled":["handleValidityChange","validateDisabled"],"checkboxItems":["validateCheckboxItems"],"displaySearchInput":["watchDisplaySearchInput"],"searchValue":["validateSearchValue"]}],[1,"mg-action-more",{"items":[16],"icon":[1040],"button":[16],"displayChevron":[4,"display-chevron"],"expanded":[32]},null,{"items":["validateItems"],"icon":["validateIcon"],"button":["validateButton"],"displayChevron":["validateDisplayChevron"]}],[1,"mg-panel",{"identifier":[1],"panelTitle":[1025,"panel-title"],"titlePattern":[1,"title-pattern"],"titlePatternErrorMessage":[1,"title-pattern-error-message"],"titleEditable":[1028,"title-editable"],"titlePosition":[1,"title-position"],"expanded":[1028],"expandToggleDisplay":[1,"expand-toggle-display"],"expandToggleDisabled":[4,"expand-toggle-disabled"],"classCollection":[32],"isEditing":[32],"updatedPanelTitle":[32]},null,{"panelTitle":["validatePanelTitle"],"titlePattern":["validateTitlePattern"],"titlePatternErrorMessage":["validateTitlePattern"],"titlePosition":["validateTitlePosition"],"expanded":["handleExpanded"],"expandToggleDisplay":["validateExpandToggleDisplay"]}],[1,"mg-input-password",{"value":[1537],"identifier":[1],"name":[1],"label":[1],"labelOnTop":[4,"label-on-top"],"labelHide":[4,"label-hide"],"placeholder":[1],"required":[4],"readonly":[4],"disabled":[4],"mgWidth":[8,"mg-width"],"tooltip":[1],"tooltipPosition":[1,"tooltip-position"],"helpText":[1,"help-text"],"valid":[1028],"invalid":[1028],"classCollection":[32],"errorMessage":[32],"displayPassword":[32],"displayError":[64],"setError":[64]},null,{"value":["handleValue"],"readonly":["watchReadonly","handleValidityChange"],"required":["handleValidityChange"],"disabled":["handleValidityChange","watchDisabled"],"mgWidth":["watchMgWidth"]}],[1,"mg-input-textarea",{"value":[1537],"identifier":[1],"name":[1],"label":[1],"labelOnTop":[4,"label-on-top"],"labelHide":[4,"label-hide"],"placeholder":[1],"maxlength":[2],"required":[4],"readonly":[4],"disabled":[4],"mgWidth":[8,"mg-width"],"pattern":[1],"patternErrorMessage":[1,"pattern-error-message"],"rows":[2],"tooltip":[1],"tooltipPosition":[1,"tooltip-position"],"displayCharacterLeft":[4,"display-character-left"],"helpText":[1,"help-text"],"valid":[1028],"invalid":[1028],"resizable":[1],"classCollection":[32],"errorMessage":[32],"displayError":[64],"setError":[64]},null,{"value":["handleValue"],"readonly":["watchReadonly","handleValidityChange"],"required":["handleValidityChange"],"disabled":["handleValidityChange","validateDisabled"],"mgWidth":["watchMgWidth"],"pattern":["validatePattern"],"patternErrorMessage":["validatePattern"],"displayCharacterLeft":["validateDisplayCharacterLeft"]}],[1,"mg-input-date",{"value":[1537],"identifier":[1],"name":[1],"label":[1],"labelOnTop":[4,"label-on-top"],"labelHide":[4,"label-hide"],"required":[4],"readonly":[4],"min":[1],"max":[1],"disabled":[4],"tooltip":[1],"tooltipPosition":[1,"tooltip-position"],"helpText":[1,"help-text"],"valid":[1028],"invalid":[1028],"classCollection":[32],"errorMessage":[32],"displayError":[64],"setError":[64]},null,{"value":["validateValue"],"readonly":["watchReadonly","handleValidityChange"],"min":["validateMinMax","handleValidityChange"],"max":["validateMinMax","handleValidityChange"],"required":["handleValidityChange"],"disabled":["handleValidityChange","watchDisabled"]}],[1,"mg-input-numeric",{"value":[1537],"identifier":[1],"name":[1],"label":[1],"labelOnTop":[4,"label-on-top"],"labelHide":[4,"label-hide"],"placeholder":[1],"required":[4],"readonly":[4],"max":[2],"min":[2],"disabled":[4],"mgWidth":[8,"mg-width"],"tooltip":[1],"tooltipPosition":[1,"tooltip-position"],"helpText":[1,"help-text"],"type":[1],"format":[1025],"currency":[1],"integerLength":[2,"integer-length"],"decimalLength":[2,"decimal-length"],"valid":[1028],"invalid":[1028],"classCollection":[32],"errorMessage":[32],"hasFocus":[32],"displayError":[64],"setError":[64]},null,{"value":["validateValue"],"readonly":["watchReadonly","handleValidityChange"],"required":["handleValidityChange"],"disabled":["handleValidityChange","watchDisabled"],"min":["handleValidityChange"],"max":["handleValidityChange"],"mgWidth":["watchMgWidth"],"type":["validateType"],"format":["watchFormat"],"integerLength":["validateIntegerLength"],"decimalLength":["validateDecimalLength"]}],[1,"mg-input-radio",{"value":[1032],"items":[16],"identifier":[1],"name":[1],"label":[1],"labelOnTop":[4,"label-on-top"],"labelHide":[4,"label-hide"],"inputVerticalList":[4,"input-vertical-list"],"required":[4],"readonly":[4],"disabled":[4],"tooltip":[1],"tooltipPosition":[1,"tooltip-position"],"helpText":[1,"help-text"],"valid":[1028],"invalid":[1028],"classCollection":[32],"errorMessage":[32],"options":[32],"displayError":[64],"setError":[64]},null,{"value":["handleValue"],"items":["validateItems"],"inputVerticalList":["watchInputVerticalList"],"readonly":["watchReadonly","handleValidityChange"],"required":["handleValidityChange"],"disabled":["handleValidityChange","watchDisabled"]}],[1,"mg-input-toggle",{"value":[1032],"items":[16],"identifier":[1],"name":[1],"label":[1],"labelOnTop":[4,"label-on-top"],"labelHide":[4,"label-hide"],"isOnOff":[4,"is-on-off"],"isIcon":[4,"is-icon"],"readonly":[4],"disabled":[4],"tooltip":[1],"tooltipPosition":[1,"tooltip-position"],"helpText":[1,"help-text"],"classCollection":[32],"options":[32],"errorMessage":[32],"valid":[32],"checked":[32],"setError":[64]},null,{"value":["handleValue"],"items":["validateItems"],"isOnOff":["watchIsOnOff"],"isIcon":["watchIsIcon"],"readonly":["watchReadonly"],"disabled":["watchDisabled"],"checked":["handleChecked"]}],[1,"mg-message",{"identifier":[1],"delay":[2],"variant":[1],"closeButton":[1028,"close-button"],"hide":[1028],"noAriaRole":[4,"no-aria-role"],"classCollection":[32],"hasActions":[32]},null,{"delay":["validateDelay"],"variant":["validateVariant"],"closeButton":["validateCloseButton"],"hide":["validateHide"]}],[1,"mg-modal",{"identifier":[1],"dialogRole":[1,"dialog-role"],"modalTitle":[1,"modal-title"],"closeButton":[4,"close-button"],"hide":[1028],"hasActions":[32],"hasContent":[32],"classCollection":[32]},[[8,"keydown","handleKeyDown"]],{"dialogRole":["validateDialogRole"],"modalTitle":["validateModalTitle"],"hide":["validateHide"]}],[1,"mg-tabs",{"identifier":[1],"label":[1],"size":[1],"items":[16],"activeTab":[1538,"active-tab"],"tabs":[32],"classCollection":[32]},null,{"label":["validateLabel"],"size":["validateSize"],"items":["validateItems"],"activeTab":["validateActiveTab"]}],[1,"mg-details",{"toggleClosed":[1,"toggle-closed"],"toggleOpened":[1,"toggle-opened"],"hideSummary":[4,"hide-summary"],"expanded":[1028]},null,{"toggleClosed":["validateTitles"],"toggleOpened":["validateTitles"],"expanded":["handleExpanded"]}],[1,"mg-divider",{"size":[1]}],[1,"mg-form",{"identifier":[1],"name":[1],"readonly":[4],"requiredMessage":[1,"required-message"],"ariaRole":[1,"aria-role"],"labelOnTop":[4,"label-on-top"],"disabled":[4],"valid":[1028],"invalid":[1028],"classCollection":[32],"requiredMessageText":[32],"displayError":[64]},null,{"requiredMessage":["validateRequiredMessage","handleAttributeChange"],"ariaRole":["validateAriaRole"],"labelOnTop":["handlelabelOnTop"],"readonly":["handleAttributeChange"],"disabled":["handleAttributeChange"]}],[1,"mg-illustrated-message",{"size":[1],"direction":[1]}],[1,"mg-skip-links",{"links":[16]},null,{"links":["validateLinks"]}],[1,"mg-tag",{"variant":[1],"outline":[4],"soft":[4],"classCollection":[32]},null,{"variant":["validateVariant"],"outline":["validateOutline"],"soft":["validateSoft"]}],[2,"mg-input-checkbox-paginated",{"readonly":[4],"disabled":[4],"name":[1],"invalid":[4],"currentPage":[1026,"current-page"],"checkboxes":[16],"sectionKind":[1,"section-kind"],"messages":[16],"titleKind":[32],"expanded":[32]},null,{"checkboxes":["validateCheckboxes"],"sectionKind":["validateSectionKind"]}],[1,"mg-pagination",{"identifier":[1],"label":[1025],"hideNavigationLabels":[4,"hide-navigation-labels"],"hidePageCount":[4,"hide-page-count"],"totalPages":[2,"total-pages"],"currentPage":[1538,"current-page"]},null,{"totalPages":["validateTotalPages"],"currentPage":["validateCurrentPage"]}],[1,"mg-input-text",{"value":[1537],"identifier":[1],"name":[1],"label":[1],"type":[1],"icon":[1],"labelOnTop":[4,"label-on-top"],"labelHide":[4,"label-hide"],"placeholder":[1],"datalistoptions":[16],"maxlength":[2],"required":[4],"readonly":[4],"disabled":[4],"mgWidth":[8,"mg-width"],"pattern":[1],"patternErrorMessage":[1,"pattern-error-message"],"tooltip":[1],"tooltipPosition":[1,"tooltip-position"],"displayCharacterLeft":[4,"display-character-left"],"helpText":[1,"help-text"],"valid":[1028],"invalid":[1028],"classCollection":[32],"errorMessage":[32],"setFocus":[64],"displayError":[64],"setError":[64]},null,{"value":["handleValue"],"icon":["validateIcon"],"datalistoptions":["validateDatalistoptions"],"readonly":["watchReadonly","handleValidityChange"],"required":["handleValidityChange"],"disabled":["handleValidityChange","watchDisabled"],"mgWidth":["watchMgWidth"],"pattern":["validatePattern"],"patternErrorMessage":["validatePattern"]}],[1,"mg-item-more",{"icon":[16],"slotlabel":[16],"size":[1],"parentMenu":[32]},null,{"icon":["validateIcon"],"slotlabel":["validateSlotLabel"],"size":["validateSize"]}],[1,"mg-menu",{"label":[1],"direction":[513],"itemmore":[16],"size":[1],"isChildMenu":[32]},null,{"label":["validateLabel"],"direction":["validateDirection"],"itemmore":["validateItemMore"],"size":["validateSize"]}],[1,"mg-menu-item",{"identifier":[1],"href":[1],"target":[1],"status":[1537],"expanded":[1028],"size":[32],"navigationButtonClassList":[32],"direction":[32],"isInMainMenu":[32],"isItemMore":[32],"hasChildren":[32],"displayNotificationBadge":[32]},null,{"target":["watchTarget"],"status":["validateStatus"],"expanded":["validateExpanded"],"size":["validateSize"],"direction":["validateDirection"],"hasChildren":["validateHasChildren"]}],[1,"mg-input-select",{"value":[1032],"items":[16],"identifier":[1],"name":[1],"label":[1],"labelOnTop":[4,"label-on-top"],"labelHide":[4,"label-hide"],"placeholder":[1025],"placeholderHide":[4,"placeholder-hide"],"placeholderDisabled":[4,"placeholder-disabled"],"required":[4],"readonly":[4],"disabled":[4],"mgWidth":[520,"mg-width"],"tooltip":[1],"tooltipPosition":[1,"tooltip-position"],"helpText":[1,"help-text"],"valid":[1028],"invalid":[1028],"classCollection":[32],"errorMessage":[32],"options":[32],"valueExist":[32],"readonlyValue":[32],"displayError":[64],"setError":[64]},null,{"value":["validateValue"],"items":["validateItems"],"readonly":["watchReadonly","handleValidityChange"],"required":["handleValidityChange"],"disabled":["handleValidityChange","watchDisabled"],"mgWidth":["watchMgWidth"]}],[2,"mg-character-left",{"identifier":[1],"characters":[1],"maxlength":[2]},null,{"maxlength":["validateMaxlength"]}],[1,"mg-popover",{"identifier":[1],"placement":[1],"arrowHide":[4,"arrow-hide"],"closeButton":[4,"close-button"],"display":[1028],"disabled":[4]},null,{"identifier":["validateIdentifier"],"arrowHide":["validateArrowHide"],"closeButton":["validateCloseButton"],"display":["handleDisplay"]}],[1,"mg-badge",{"value":[8],"label":[1],"variant":[1],"outline":[4],"classCollection":[32]},null,{"value":["validateValue"],"label":["validateLabel"],"variant":["validateVariant"],"outline":["validateOutline"]}],[1,"mg-popover-content",{"closeButton":[4,"close-button"],"classCollection":[32]}],[1,"mg-card",{"variant":[1],"variantStyle":[1025,"variant-style"],"classCollection":[32]},null,{"variant":["validateVariant"],"variantStyle":["validateVariantStyle"]}],[1,"mg-input",{"identifier":[1],"label":[1],"labelOnTop":[4,"label-on-top"],"labelHide":[4,"label-hide"],"tooltip":[1],"tooltipPosition":[1,"tooltip-position"],"required":[4],"readonlyValue":[1,"readonly-value"],"errorMessage":[1,"error-message"],"helpText":[1,"help-text"],"ariaDescribedbyIDs":[16],"isFieldset":[32],"isReadonly":[32],"isDisabled":[32],"isVerticalList":[32]},null,{"identifier":["watchIdentifier","watchAriaDescribedbyIDs"],"labelOnTop":["watchLabelOnTop","watchLabelConfig"],"labelHide":["watchLabelConfig"],"tooltipPosition":["watchTooltipPosition"],"errorMessage":["watchErrorMessage","watchAriaDescribedbyIDs"],"helpText":["watchHelpText","watchAriaDescribedbyIDs"],"ariaDescribedbyIDs":["watchAriaDescribedbyIDs"],"class":["watchClass","watchLabel"],"label":["watchLabel"]}],[1,"mg-button",{"variant":[1],"identifier":[1],"label":[1],"type":[1],"fullWidth":[4,"full-width"],"form":[1],"disabled":[1028],"isIcon":[4,"is-icon"],"disableOnClick":[4,"disable-on-click"],"loading":[32],"classCollection":[32]},null,{"variant":["validateVariant"],"fullWidth":["validateFullWidth"],"disabled":["disabledHandler"],"loading":["loadingHandler"]}],[1,"mg-tooltip",{"identifier":[1],"message":[1],"placement":[1],"display":[1028],"disabled":[4]},null,{"identifier":["validateIdentifier"],"message":["validateMessage"],"display":["handleDisplay"],"disabled":["validateDisabled"]}],[6,"mg-input-title",{"identifier":[1],"required":[4],"readonly":[4],"isLegend":[4,"is-legend"],"tagName":[32]},null,{"identifier":["validateIdentifier"],"isLegend":["validateIsLegend"]}],[1,"mg-tooltip-content",{"message":[1]}],[1,"mg-icon",{"icon":[1],"size":[1],"variant":[1],"variantStyle":[1025,"variant-style"],"spin":[4],"classCollection":[32]},null,{"icon":["validateIcon"],"size":["validateSize"],"variant":["validateVariant"],"variantStyle":["validateVariantStyle"],"spin":["handleSpin"]}]]],["mg-loader",[[1,"mg-loader",{"message":[1],"messageHide":[4,"message-hide"]},null,{"message":["watchMessage"]}]]]]'),t)};(function(){if(typeof window<"u"&&window.Reflect!==void 0&&window.customElements!==void 0){var e=HTMLElement;window.HTMLElement=function(){return Reflect.construct(e,[],this.constructor)},HTMLElement.prototype=e.prototype,HTMLElement.prototype.constructor=HTMLElement,Object.setPrototypeOf(HTMLElement,e)}})();ry();Be.setStencilDocJson(uv);const ly={controls:{matchers:{color:/(background|color)$/i,date:/Date$/}},docs:{extractArgTypes:Be.extractArgTypes,extractComponentDescription:Be.extractComponentDescription,transformSource:(e,t)=>wl(t.originalStoryFn(t.args))},options:{storySort:{order:["Intro","Atoms","Molecules","Style"]}}},iy={locale:{name:"Locale",description:"Internationalization locale",toolbar:{icon:"globe",items:[{value:"en",title:"English"},{value:"fr",title:"Français"}],showName:!0}}},sy=[$l,rv],fy=Object.freeze(Object.defineProperty({__proto__:null,decorators:sy,globalTypes:iy,parameters:ly},Symbol.toStringTag,{value:"Module"}));export{xv as H,gy as c,Iv as g,tl as h,fy as p,my as r};
