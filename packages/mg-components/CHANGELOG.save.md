...
- [#265](https://gitlab.mgdis.fr/core/core-ui/mg-components/-/issues/265) mg-menu: responsive menu does not accept click events in vue 3
...
- [**`<mg-action-more>`**](./?path=/docs/molecules-mg-action-more--mg-action-more)
...
- [**`<mg-skip-links>`**](./?path=/docs/molecules-mg-skip-links--mg-skip-links)
