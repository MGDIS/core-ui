...
| `itemmore`           | --          | Customize "mg-item-more" element Used with direction: 'vertical' to manage overflow                                                                                                                              | `{ icon?: IconType; slotlabel?: SlotLabelType; }` | `undefined`    |
...
| `size`               | --          | <span style="color:red">**[DEPRECATED]**</span> this prop is deprecated and will be removed in future releases. Please use CSS custom properties to set the size of menu items.<br/><br/>Size of the menu items. | `never`                                           | `undefined`    |
