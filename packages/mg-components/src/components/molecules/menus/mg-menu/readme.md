...
| `itemmore`           | --          | Customize "mg-item-more" element Used with direction: 'vertical' to manage overflow                          | `{ icon?: IconType; size?: "medium" \| "large" \| "xlarge"; slotlabel?: SlotLabelType; }` | `undefined`    |
