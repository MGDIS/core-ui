...
| `itemmore`           | `itemmore`  | Customize "mg-item-more" element Used with direction: 'vertical' to manage overflow                          | `{ size?: "medium" \| "large" \| "xlarge"; icon?: IconType; slotlabel?: SlotLabelType; }` | `undefined`    |
