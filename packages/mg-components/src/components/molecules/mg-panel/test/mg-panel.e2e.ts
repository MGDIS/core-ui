...
describe('mg-panel', () => {
  describe.each([
    ...
    `<mg-panel label="label" panel-title="panel title" expanded><div>header right items should be vertically aligned</div><div slot="header-right"><mg-tag>Label</mg-tag><mg-icon size="small" icon="check-circle" variant="success"></mg-icon></div></mg-panel>`,
