...
test.describe('mg-panel', () => {
  [
    ...
    { expanded: true, style: '--mg-panel-content-padding: 0', slot: '<div>Content without padding.</div>' },
    { expanded: true, style: '--mg-panel-background: none; --mg-panel-border-radius: 0; --mg-panel-box-shadow: none', slot: '<div>Transparent mg-panel</div>' },
    {
      expanded: true,
    ...
    { expanded: true, style: '--mg-panel-background: var(--color-danger)', slot: '<mg-card>Content with child card.</mg-card>' },
  ].forEach(args => {
