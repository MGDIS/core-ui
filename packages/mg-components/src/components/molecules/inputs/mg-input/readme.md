...
| `labelHeading`            | `label-heading`         | Define label heading, use to define label with associated semantic You must pair this mode with `labelOnTop`and `fieldset` class | `"h1" \| "h2" \| "h3" \| "h4" \| "h5" \| "h6"` | `undefined` |
