...
| `editButtonMessage`       | `edit-button-message`     | Define edit button message                                                                                                                                                                                                                                                       | `string`                | `undefined`       |
...
| `selectButtonMessage`     | `select-button-message`   | Define sele btButton message                                                                                                                                                                                                                                                     | `string`                | `undefined`       |
| `showButtonMessage`       | `show-button-message`     | Define show button message                                                                                                                                                                                                                                                       | `string`                | `undefined`       |
