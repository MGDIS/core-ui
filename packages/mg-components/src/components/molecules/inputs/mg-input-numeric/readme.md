...
| `format`                  | `format`           | Set local formatting. Numbers are formatted based on the locale. When type is set to `currency`, formatting has no effect.                     | `"currency" \| "none" \| "number"`     | `'number'`        |
...
| `type`                    | `type`             | Define numeric type                                                                                                                            | `"currency" \| "decimal" \| "integer"` | `'decimal'`       |
