 ...
 * @returns HTMLElement
 */
const Template = (args: MgIllustratedMessageType & { details: string; illustration: string; title: string }): HTMLElement => (
  <mg-illustrated-message
    {...filterArgs(
      ...
      ['details', 'illustration', 'title'],
    )}
    innerHTML={`${args.details}${args.illustration}${args.title}`}
  ></mg-illustrated-message>
);
