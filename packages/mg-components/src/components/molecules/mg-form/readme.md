...
| `requiredMessageHide` | `required-message-hide` | Define if required message is hidden. When you toggle the prop to true, it will not render the message element in component DOM. As **this element is an accessibility requirement in the view**, you must re-implement this message by your own and display it when you form contain required inputs. | `boolean` | `undefined`           |
